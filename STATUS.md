...
| Neutrino propagation mass | `CONDITIONAL_PROPAGATION_THEOREM` | Author ontology defines propagation -> curvature threshold -> effective mass response | Numerical curvature response and comparison scale remain open | `python -m bhsm.interface close-minimal-action neutrino_basis_scale` |
