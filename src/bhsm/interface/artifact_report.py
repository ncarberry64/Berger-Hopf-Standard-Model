...
def build_artifact_prediction_report(
    ...
    return ArtifactPredictionReport(
        ...
        claim_boundaries=["Artifact presence does not close a theorem.", "The neutrino propagation candidate is dimensionless until an artifact-backed neutral eV/GeV scale exists.", "Boundary seeds are not physical production vertices without their missing theorems."],
