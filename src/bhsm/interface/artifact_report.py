...
def build_artifact_prediction_report(
    ...
    return ArtifactPredictionReport(
        ...
        claim_boundaries=["Artifact presence does not close a theorem.", "The neutral spectral-gap theorem shape is conditional; numeric stiffness length, physical curvature, and admissible positivity remain open.", "The legacy gravitational expression is dimensionally gated as mass per length and is not a particle-mass formula.", "Boundary seeds are not physical production vertices without their missing theorems."],
