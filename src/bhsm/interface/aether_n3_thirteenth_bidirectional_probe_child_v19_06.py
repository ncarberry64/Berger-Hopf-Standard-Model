"""Reconstruct the complete child for the selected v19.05 merit state."""
...
VERSION = "v19.06"
CLASSIFICATION = "BHSM_N3_THIRTEENTH_BIDIRECTIONAL_PROBE_CHILD"
FULL_BHSM_COMPLETE = False


def thirteenth_bidirectional_probe_child() -> dict[str, Any]:
    proposal_artifact = json.loads(Path(
        "artifacts/BHSM_aether_n3_thirteenth_bidirectional_merit_manifold_probe_v19_05.json"
    ).read_text(encoding="utf-8"))
    proposal = proposal_artifact["thirteenth_bidirectional_merit_manifold_probe"]
    selected = proposal["selected_true_merit_candidate_pending_child_acceptance"]
    raw = v19_05_selected_raw_vector()
    ...
    ).read_text(encoding="utf-8"))["twelfth_bidirectional_probe_child"]["child_state"]
    germ = _pack_child(
    ...
    return {
        ...
        "source_event": "v19.05_bidirectional_exact_merit_candidate",
        "source_solver_interpretation": "INVALIDATED_NOT_REASSERTED",
        "source_germ": "v19.02_child_of_accepted_v19.03_state",
...
def completion_payload() -> dict[str, Any]:
    result = thirteenth_bidirectional_probe_child()
    chart = result["chart"]
    ...
    return {
        "artifact": "BHSM_aether_n3_thirteenth_bidirectional_probe_child_v19_06",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "thirteenth_bidirectional_probe_child": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_thirteenth_bidirectional_probe_child_v19_06.json"
...
__all__ = [
    ...
    "thirteenth_bidirectional_probe_child", "completion_payload", "materialize",
]
