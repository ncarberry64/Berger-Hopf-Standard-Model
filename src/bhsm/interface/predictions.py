...
def default_prediction_registry() -> PredictionRegistry:
    ...
    entries = [
        ...
        _entry("neutral_operator_kernel_BH", "Neutral propagation-response kernel", "neutral", "propagation_conditioned_effective_mass", PredictionStatus.CONDITIONAL_THEOREM,
               "The neutral boundary seed supports a conditional dimensionless propagation-mass candidate; the eV/GeV neutral scale remains open.", theorem="CONDITIONAL_NUMERICAL_CLOSURE_CANDIDATE",
               artifacts=("artifacts/BHSM_neutrino_basis_scale_minimal_action_closure_v0_8.json", "artifacts/BHSM_neutrino_numerical_closure_report_v0_9.json", "artifacts/BHSM_author_ontology_v0_8.json"), excluded="not a static rest-mass matrix, dimensional mass prediction, or production vertex"),
