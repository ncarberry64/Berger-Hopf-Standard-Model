...
def default_prediction_registry() -> PredictionRegistry:
    ...
    entries = [
        ...
        _entry("neutral_operator_kernel_BH", "Neutral propagation-response kernel", "neutral", "propagation_conditioned_effective_mass", PredictionStatus.CONDITIONAL_THEOREM,
               "The neutral boundary seed supports a conditional propagation-locked curvature-response theorem; numerical scale remains open.", theorem="CONDITIONAL_PROPAGATION_THEOREM",
               artifacts=("artifacts/BHSM_neutrino_dirac_majorana_basis_scale_theorem_v1_1.json", "artifacts/BHSM_neutrino_basis_scale_minimal_action_closure_v0_8.json", "artifacts/BHSM_author_ontology_v0_8.json"), excluded="not a static rest-mass matrix or production vertex"),
