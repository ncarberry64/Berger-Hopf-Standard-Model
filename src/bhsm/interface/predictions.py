...
def default_prediction_registry() -> PredictionRegistry:
    ...
    entries = [
        ...
        _entry("neutral_operator_kernel_BH", "Neutral propagation-response kernel", "neutral", "propagation_conditioned_effective_mass", PredictionStatus.CONDITIONAL_THEOREM,
               "The neutral boundary seed supports a conditional dimensionless propagation-mass candidate; a legacy curvature mass functional is available, while r_prop and physical k_neutral,eff remain open.", theorem="CONDITIONAL_NUMERICAL_CLOSURE_CANDIDATE",
