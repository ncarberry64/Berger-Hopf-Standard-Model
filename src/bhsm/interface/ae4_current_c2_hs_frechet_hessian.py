...
def claim_boundary() -> dict[str, Any]:
    return {
        ...
        "AE4_FULL_1222_DENSE_GENERALIZED_EIGENSOLVE_NUMERICALLY_ADMISSIBLE": False,
        "AE4_FULL_CORE_FACTORIZED_OR_TRANSFER_RESOLVENT_REQUIRED": True,
        ...
        "exact_next_calculation": (
            "EXTEND_THE_CURRENT_C2_BIRTH_LOCAL_AE4_HS_HESSIAN_WITH_THE_"
            "FIRST_ORDER_PRODUCT_DIRAC_FACTORIZATION_OR_AN_INVERSE_FREE_"
            "STURM_TRANSFER_RESOLVENT_TO_THE_FULL_FINITE_CORE_THEN_THE_RESET_"
