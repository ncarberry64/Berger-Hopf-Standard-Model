...
def composite_theta_bundle_payload() -> dict[str, Any]:
    ...
    return {
        ...
        "status_of_equality": "CANONICAL_ASSOCIATED_BUNDLE_GEOMETRY_AND_DEFINITION_AFTER_ADOPTING_THE_COMMON_PHYSICAL_SU3_BUNDLE; NOT_AN_EULER_LAGRANGE_EQUATION_OR_ACTION_DERIVATION",
        "transformation_law": "theta_M -> Ad_h theta_M under h in SU3",
        "original_M8_eta_to_collar_section_map": None,
...
def theta_hessian_payload() -> dict[str, Any]:
    ...
    return {
        ...
        "vacuum_blocks": {
            "H_AA": "g3^-2 delta_ab[-h_mn partial^2+(1-alpha^-1)partial_m partial_n] after covariant gauge fixing",
            "H_A_eta": "0 at A=0 and the SU3-fixed coset base point because K_a(eta0)=0",
            "H_eta_eta": "w kappa1(-partial^2) on six tangent scalars; X^4 begins at eighth fluctuation order",
            "H_theta_theta": None,
            "Faddeev_Popov": "-partial^2 delta_ab at the selected vacuum",
        },
        "scope": "conditional candidate common-domain Hessian; not a proof of the missing M8-to-collar action reduction",
