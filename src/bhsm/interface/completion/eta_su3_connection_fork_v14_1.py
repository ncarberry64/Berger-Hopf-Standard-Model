...
def completion_payload() -> dict[str, Any]:
    ...
    validation = {
        ...
        "retained_matcher_absent": matcher["validation_passed"] and matcher["retained_matcher"] is None,
    ...
    return {
        ...
        "Mark_III": "BLOCKED_BY_MISSING_CROSS_STRATUM_BUNDLE_CONNECTION_ACTION_OBJECT",
