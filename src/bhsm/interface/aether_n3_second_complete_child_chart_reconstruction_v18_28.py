"""Recompute the complete-child chart at the v18.27 event candidate."""
...
VERSION = "v18.28"
CLASSIFICATION = "BHSM_N3_SECOND_COMPLETE_CHILD_CHART_RECONSTRUCTION"
FULL_BHSM_COMPLETE = False


def second_complete_child_chart_reconstruction() -> dict[str, Any]:
    """Solve all 14 child boundary rows on a recomputed rank-14 chart."""
    raw = v18_27_selected_raw_vector()
    ...
    prior_child = prior["complete_child_chart_reconstruction"]["child_state"]
    germ = _pack_child(
    ...
    return {
        "source_event": "v18.27_fine_directional_merit_candidate",
        "source_germ": "v18.24_validated_complete_child",
...
def completion_payload() -> dict[str, Any]:
    result = second_complete_child_chart_reconstruction()
    chart = result["chart"]
    ...
    validation = {
        ...
        "numerical_row_scaling_does_not_change_zero_set": (
    ...
    return {
        "artifact": "BHSM_aether_n3_second_complete_child_chart_reconstruction_v18_28",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "second_complete_child_chart_reconstruction": result,
        "status": "VALIDATED" if passed else "INVALIDATED",
        "real_physical_property_explained": (
            "THE_V18_27_EVENT_SELECTS_A_COMPLETE_MOVING_CHILD_ON_A_RECOMPUTED_"
            "FULL_RANK_LOCAL_CHART"
        ),
        "dependency_advanced": "NONLINEAR_N3_EVENT_SADDLE_CLOSURE",
        "active_calculation": (
            "VERIFY_FLUX_ENVELOPE_AND_POSITIVE_DURATION_PERSISTENCE_THEN_PROMOTE_"
            "THE_GLOBAL_STEP"
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_second_complete_child_chart_reconstruction_v18_28.json"
