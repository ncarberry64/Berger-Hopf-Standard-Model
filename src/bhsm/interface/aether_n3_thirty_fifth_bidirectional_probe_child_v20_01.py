"""Reconstruct the complete child for the selected v20.00 merit state."""
...
VERSION = "v20.01"
CLASSIFICATION = "BHSM_N3_THIRTY_FIFTH_BIDIRECTIONAL_PROBE_CHILD"
FULL_BHSM_COMPLETE = False


def thirty_fifth_bidirectional_probe_child() -> dict[str, Any]:
    ...
    proposal = proposal_artifact["thirty_fifth_bidirectional_merit_manifold_probe"]
    selected = proposal["selected_true_merit_candidate_pending_child_acceptance"]
    raw = v20_00_selected_raw_vector()
    ...
    ).read_text(encoding="utf-8"))["thirty_fourth_bidirectional_probe_child"]["child_state"]
    germ = _pack_child(
    ...
    return {
        ...
        "source_event": "v20.00_bidirectional_exact_merit_candidate",
...
def completion_payload() -> dict[str, Any]:
    result = thirty_fifth_bidirectional_probe_child()
    chart = result["chart"]
    ...
    return {
        "artifact": "BHSM_aether_n3_thirty_fifth_bidirectional_probe_child_v20_01",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "thirty_fifth_bidirectional_probe_child": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_thirty_fifth_bidirectional_probe_child_v20_01.json"
...
__all__ = [
    ...
    "thirty_fifth_bidirectional_probe_child", "completion_payload", "materialize",
]
