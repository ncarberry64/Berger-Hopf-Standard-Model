"""Remeasure direct residual response scales at accepted v18.95."""
...
from bhsm.interface.aether_n3_tenth_bidirectional_probe_promotion_v18_95 import (
    v18_95_selected_raw_vector,
)


VERSION = "v18.96"
CLASSIFICATION = "BHSM_N3_FOURTEENTH_DIRECT_RESIDUAL_SCALE_AUDIT"
FULL_BHSM_COMPLETE = False
SOURCE_NORM = 0.801684037952532


def fourteenth_direct_residual_scale_audit() -> dict[str, Any]:
...
def completion_payload() -> dict[str, Any]:
    result = fourteenth_direct_residual_scale_audit()
    ...
    return {
        "artifact": "BHSM_aether_n3_fourteenth_direct_residual_scale_audit_v18_96",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "fourteenth_direct_residual_scale_audit": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_fourteenth_direct_residual_scale_audit_v18_96.json"
...
__all__ = [
    ...
    "CLASSIFICATION",
    "FULL_BHSM_COMPLETE",
    "fourteenth_direct_residual_scale_audit",
    "completion_payload",
    "materialize",
]
