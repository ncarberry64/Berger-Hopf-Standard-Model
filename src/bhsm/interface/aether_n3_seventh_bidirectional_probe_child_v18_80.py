"""Reconstruct the complete child for the selected v18.79 merit state."""
...
VERSION = "v18.80"
CLASSIFICATION = "BHSM_N3_SEVENTH_BIDIRECTIONAL_PROBE_CHILD"
FULL_BHSM_COMPLETE = False


def seventh_bidirectional_probe_child() -> dict[str, Any]:
    ...
    raw = v18_79_selected_raw_vector()
    ...
    return {
        "line_selection": {
            ...
            "selected_by": (
                "LOWEST_INDEPENDENT_EXACT_MERIT_ACROSS_BOTH_ORIENTATIONS"
            ),
        },
        "source_event": "v18.79_bidirectional_exact_merit_candidate",
...
def completion_payload() -> dict[str, Any]:
    result = seventh_bidirectional_probe_child()
    chart = result["chart"]
    rows = result["physical_residuals"]
    validation = {
        "bidirectional_exact_merit_selection": result["line_selection"][
            "selected_by"
        ].startswith("LOWEST_INDEPENDENT"),
    ...
    return {
        "artifact": "BHSM_aether_n3_seventh_bidirectional_probe_child_v18_80",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "seventh_bidirectional_probe_child": result,
        "status": "VALIDATED" if passed else "INVALIDATED",
        "real_physical_property_explained": (
            "THE_LOWEST_V18_79_EXACT_MERIT_STATE_SELECTS_A_COMPLETE_"
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_seventh_bidirectional_probe_child_v18_80.json"
...
__all__ = [
    ...
    "CLASSIFICATION",
    "FULL_BHSM_COMPLETE",
    "seventh_bidirectional_probe_child",
    "completion_payload",
    "materialize",
]
