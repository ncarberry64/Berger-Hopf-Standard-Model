"""Reconstruct the next v20.16 child after the v19.80 flux rejection."""
...
VERSION = "v20.19"
CLASSIFICATION = "BHSM_N3_THIRTY_NINTH_BIDIRECTIONAL_FALLBACK_CHILD"
...
def v20_19_selected_raw_vector() -> np.ndarray:
...
def thirty_ninth_bidirectional_fallback_child() -> dict[str, Any]:
    selected = _fallback_candidate()
    raw = v20_19_selected_raw_vector()
    ...
    prior = json.loads(
        Path(
            "artifacts/BHSM_aether_n3_thirty_eighth_bidirectional_probe_child_v20_13.json"
        ).read_text(encoding="utf-8")
    )["thirty_eighth_bidirectional_probe_child"]["child_state"]
    germ = _pack_child(
    ...
    return {
        "line_selection": {
            ...
            "selected_by": (
                "NEXT_LOWEST_INDEPENDENT_EXACT_MERIT_AFTER_V20_18_"
                "FLUX_REJECTION"
            ),
        },
        "rejected_predecessor": {
            "state": "v20.16_primary_candidate",
            "rejection_gate": "INDEPENDENT_TWO_SCALE_FLUX_ENVELOPE",
            "measured_envelope": 2.3327599244e-5,
            "retained_limit": 2.0e-5,
            "acceptance_gate_changed": False,
        },
        "source_event": "v20.16_next_exact_merit_candidate",
        "source_solver_interpretation": "INVALIDATED_NOT_REASSERTED",
        "source_germ": "v20.13_child_of_accepted_v20.14_state",
...
def completion_payload() -> dict[str, Any]:
    result = thirty_ninth_bidirectional_fallback_child()
    chart = result["chart"]
    ...
    return {
        "artifact": "BHSM_aether_n3_thirty_ninth_bidirectional_fallback_child_v20_19",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "thirty_ninth_bidirectional_fallback_child": result,
...
__all__ = [
    ...
    "thirty_ninth_bidirectional_fallback_child",
    "completion_payload",
    "materialize",
]
