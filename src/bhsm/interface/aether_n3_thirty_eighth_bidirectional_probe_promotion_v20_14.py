"""Promote the v20.12 merit state only after the complete physical gate."""
...
from bhsm.interface.aether_n3_thirty_eighth_bidirectional_merit_manifold_probe_v20_12 import v20_12_selected_raw_vector
...
VERSION = "v20.14"
CLASSIFICATION = "BHSM_N3_THIRTY_EIGHTH_BIDIRECTIONAL_PROBE_PROMOTION"
FULL_BHSM_COMPLETE = False


def v20_14_selected_raw_vector() -> np.ndarray:
    return v20_12_selected_raw_vector().copy()


def thirty_eighth_bidirectional_probe_promotion() -> dict[str, Any]:
    reconstruction = json.loads(Path(
        "artifacts/BHSM_aether_n3_thirty_eighth_bidirectional_probe_child_v20_13.json"
    ).read_text(encoding="utf-8"))
    child = reconstruction["thirty_eighth_bidirectional_probe_child"]
    ...
    source_raw = v20_10_selected_raw_vector()
...
def completion_payload() -> dict[str, Any]:
    result = thirty_eighth_bidirectional_probe_promotion()
    ...
    return {
        "artifact": "BHSM_aether_n3_thirty_eighth_bidirectional_probe_promotion_v20_14",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "thirty_eighth_bidirectional_probe_promotion": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_thirty_eighth_bidirectional_probe_promotion_v20_14.json"
    path.write_text(deterministic_json(completion_payload()), encoding="utf-8")
    return path


__all__ = [
    "VERSION", "CLASSIFICATION", "FULL_BHSM_COMPLETE", "v20_14_selected_raw_vector",
    "thirty_eighth_bidirectional_probe_promotion", "completion_payload", "materialize",
]
