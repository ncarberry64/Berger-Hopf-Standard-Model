"""Reconstruct the complete child for the independent v18.39 line state."""
...
VERSION = "v18.40"
CLASSIFICATION = "BHSM_N3_SECOND_DIRECT_LINE_CHILD"
FULL_BHSM_COMPLETE = False


def second_direct_line_child() -> dict[str, Any]:
    raw = v18_39_selected_raw_vector()
    ...
    prior_child = prior["direct_jfnk_proposal_child"]["child_state"]
    germ = _pack_child(
    ...
    return {
        "source_event": "v18.39_independent_exact_merit_line_proposal",
        "source_solver_model": "INVALIDATED_NOT_REASSERTED",
        "source_germ": "v18.36_validated_complete_child",
...
def completion_payload() -> dict[str, Any]:
    result = second_direct_line_child()
    chart = result["chart"]
    ...
    return {
        "artifact": "BHSM_aether_n3_second_direct_line_child_v18_40",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "second_direct_line_child": result,
        "status": "VALIDATED" if passed else "INVALIDATED",
        "real_physical_property_explained": (
            "THE_INDEPENDENT_V18_39_LINE_STATE_SELECTS_A_COMPLETE_MOVING_CHILD_"
            "WITHOUT_REASSERTING_THE_INVALIDATED_DIRECTION"
        ),
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_second_direct_line_child_v18_40.json"
