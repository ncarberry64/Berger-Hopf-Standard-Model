"""Promote the v20.19 fallback child only after the complete physical gate."""
...
from bhsm.interface.aether_n3_thirty_ninth_bidirectional_fallback_child_v20_19 import (
    v20_19_selected_raw_vector,
)
from bhsm.interface.aether_n3_thirty_eighth_bidirectional_probe_promotion_v20_14 import (
    v20_14_selected_raw_vector,
)


VERSION = "v20.20"
CLASSIFICATION = "BHSM_N3_THIRTY_NINTH_BIDIRECTIONAL_FALLBACK_PROMOTION"
FULL_BHSM_COMPLETE = False


def v20_20_selected_raw_vector() -> np.ndarray:
    return v20_19_selected_raw_vector().copy()


def thirty_ninth_bidirectional_fallback_promotion() -> dict[str, Any]:
    reconstruction = json.loads(
        Path(
            "artifacts/"
            "BHSM_aether_n3_thirty_ninth_bidirectional_fallback_child_v20_19.json"
        ).read_text(encoding="utf-8")
    )
    child = reconstruction["thirty_ninth_bidirectional_fallback_child"]
    ...
    source_raw = v20_14_selected_raw_vector()
    raw = v20_20_selected_raw_vector()
...
def completion_payload() -> dict[str, Any]:
    result = thirty_ninth_bidirectional_fallback_promotion()
    ...
    return {
        "artifact": (
            "BHSM_aether_n3_thirty_ninth_bidirectional_fallback_promotion_v20_20"
        ),
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "thirty_ninth_bidirectional_fallback_promotion": result,
...
__all__ = [
    ...
    "CLASSIFICATION",
    "FULL_BHSM_COMPLETE",
    "v20_20_selected_raw_vector",
    "thirty_ninth_bidirectional_fallback_promotion",
    "completion_payload",
    "materialize",
]
