"""Reconstruct the complete child for the selected v18.66 merit state."""
...
VERSION = "v18.67"
CLASSIFICATION = "BHSM_N3_FOURTH_BIDIRECTIONAL_PROBE_CHILD"
FULL_BHSM_COMPLETE = False


def fourth_bidirectional_probe_child() -> dict[str, Any]:
    proposal = json.loads(Path("artifacts/BHSM_aether_n3_fourth_bidirectional_merit_manifold_probe_v18_66.json").read_text(encoding="utf-8"))["fourth_bidirectional_merit_manifold_probe"]
    selected = proposal["selected_true_merit_candidate_pending_child_acceptance"]
    raw = v18_66_selected_raw_vector()
    ...
    prior = json.loads(Path("artifacts/BHSM_aether_n3_third_bidirectional_probe_child_v18_63.json").read_text(encoding="utf-8"))["third_bidirectional_probe_child"]["child_state"]
    ...
    return {
        ...
        "source_event": "v18.66_bidirectional_exact_merit_candidate",
        "source_solver_interpretation": "INVALIDATED_NOT_REASSERTED",
        "source_germ": "v18.63_child_of_accepted_v18.64_state",
...
def completion_payload() -> dict[str, Any]:
    result = fourth_bidirectional_probe_child()
    chart = result["chart"]
    ...
    return {
        "artifact": "BHSM_aether_n3_fourth_bidirectional_probe_child_v18_67",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "fourth_bidirectional_probe_child": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_fourth_bidirectional_probe_child_v18_67.json"
    path.write_text(deterministic_json(completion_payload()), encoding="utf-8")
    return path


__all__ = ["VERSION", "CLASSIFICATION", "FULL_BHSM_COMPLETE", "fourth_bidirectional_probe_child", "completion_payload", "materialize"]
