"""Remeasure direct residual response scales at accepted v19.21."""
...
from bhsm.interface.aether_n3_sixteenth_bidirectional_probe_promotion_v19_21 import (
    v19_21_selected_raw_vector,
)


VERSION = "v19.22"
CLASSIFICATION = "BHSM_N3_TWENTIETH_DIRECT_RESIDUAL_SCALE_AUDIT"
FULL_BHSM_COMPLETE = False
SOURCE_NORM = 0.795019734745765


def twentieth_direct_residual_scale_audit() -> dict[str, Any]:
...
def completion_payload() -> dict[str, Any]:
    result = twentieth_direct_residual_scale_audit()
    ...
    return {
        "artifact": "BHSM_aether_n3_twentieth_direct_residual_scale_audit_v19_22",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "twentieth_direct_residual_scale_audit": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_twentieth_direct_residual_scale_audit_v19_22.json"
...
__all__ = [
    ...
    "CLASSIFICATION",
    "FULL_BHSM_COMPLETE",
    "twentieth_direct_residual_scale_audit",
    "completion_payload",
    "materialize",
]
