"""Reconstruct the complete child for the selected v19.19 merit state."""
...
VERSION = "v19.20"
CLASSIFICATION = "BHSM_N3_SIXTEENTH_BIDIRECTIONAL_PROBE_CHILD"
FULL_BHSM_COMPLETE = False


def sixteenth_bidirectional_probe_child() -> dict[str, Any]:
    proposal_artifact = json.loads(Path(
        "artifacts/BHSM_aether_n3_sixteenth_bidirectional_merit_manifold_probe_v19_19.json"
    ).read_text(encoding="utf-8"))
    proposal = proposal_artifact["sixteenth_bidirectional_merit_manifold_probe"]
    selected = proposal["selected_true_merit_candidate_pending_child_acceptance"]
    raw = v19_19_selected_raw_vector()
    ...
    ).read_text(encoding="utf-8"))["fifteenth_bidirectional_probe_child"]["child_state"]
    germ = _pack_child(
    ...
    return {
        ...
        "source_event": "v19.19_bidirectional_exact_merit_candidate",
        "source_solver_interpretation": "INVALIDATED_NOT_REASSERTED",
        "source_germ": "v19.16_child_of_accepted_v19.17_state",
...
def completion_payload() -> dict[str, Any]:
    result = sixteenth_bidirectional_probe_child()
    chart = result["chart"]
    ...
    return {
        "artifact": "BHSM_aether_n3_sixteenth_bidirectional_probe_child_v19_20",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "sixteenth_bidirectional_probe_child": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_sixteenth_bidirectional_probe_child_v19_20.json"
...
__all__ = [
    ...
    "sixteenth_bidirectional_probe_child", "completion_payload", "materialize",
]
