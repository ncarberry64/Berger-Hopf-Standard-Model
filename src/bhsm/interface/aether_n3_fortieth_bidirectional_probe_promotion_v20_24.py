"""Promote the v20.22 merit state only after the complete physical gate."""
...
from bhsm.interface.aether_n3_fortieth_bidirectional_merit_manifold_probe_v20_22 import v20_22_selected_raw_vector
...
VERSION = "v20.24"
CLASSIFICATION = "BHSM_N3_FORTIETH_BIDIRECTIONAL_PROBE_PROMOTION"
FULL_BHSM_COMPLETE = False


def v20_24_selected_raw_vector() -> np.ndarray:
    return v20_22_selected_raw_vector().copy()


def fortieth_bidirectional_probe_promotion() -> dict[str, Any]:
    reconstruction = json.loads(Path(
        "artifacts/BHSM_aether_n3_fortieth_bidirectional_probe_child_v20_23.json"
    ).read_text(encoding="utf-8"))
    child = reconstruction["fortieth_bidirectional_probe_child"]
    ...
    source_raw = v20_20_selected_raw_vector()
...
def completion_payload() -> dict[str, Any]:
    result = fortieth_bidirectional_probe_promotion()
    ...
    return {
        "artifact": "BHSM_aether_n3_fortieth_bidirectional_probe_promotion_v20_24",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "fortieth_bidirectional_probe_promotion": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_fortieth_bidirectional_probe_promotion_v20_24.json"
    path.write_text(deterministic_json(completion_payload()), encoding="utf-8")
    return path


__all__ = [
    "VERSION", "CLASSIFICATION", "FULL_BHSM_COMPLETE", "v20_24_selected_raw_vector",
    "fortieth_bidirectional_probe_promotion", "completion_payload", "materialize",
]
