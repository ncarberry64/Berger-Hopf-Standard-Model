"""Remeasure direct residual response scales at accepted v19.76."""
...
VERSION = "v19.77"
CLASSIFICATION = "BHSM_N3_THIRTY_THIRD_DIRECT_RESIDUAL_SCALE_AUDIT"
FULL_BHSM_COMPLETE = False
SOURCE_NORM = 0.783424601549721
STEPS_V19_77 = (*STEPS_V18_70, 1.0e-8, 3.0e-9)


def thirty_third_direct_residual_scale_audit() -> dict[str, Any]:
    ...
    common_pairs = []
    for coarse, fine in zip(STEPS_V19_77[:-1], STEPS_V19_77[1:]):
        rows = [
            next(
                row
...
def completion_payload() -> dict[str, Any]:
    result = thirty_third_direct_residual_scale_audit()
    ...
    validation = {
        ...
        "all_scales_measured": all(
            len(row["responses"]) == len(STEPS_V19_77)
    ...
    return {
        "artifact": "BHSM_aether_n3_thirty_third_direct_residual_scale_audit_v19_77",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "thirty_third_direct_residual_scale_audit": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_thirty_third_direct_residual_scale_audit_v19_77.json"
...
__all__ = [
    ...
    "CLASSIFICATION",
    "FULL_BHSM_COMPLETE",
    "thirty_third_direct_residual_scale_audit",
    "completion_payload",
    "materialize",
]
