"""Reconstruct the complete child for the selected v19.84 merit state."""
...
VERSION = "v19.85"
CLASSIFICATION = "BHSM_N3_THIRTY_FIRST_BIDIRECTIONAL_PROBE_CHILD"
FULL_BHSM_COMPLETE = False


def thirty_first_bidirectional_probe_child() -> dict[str, Any]:
    ...
    proposal = proposal_artifact["thirty_first_bidirectional_merit_manifold_probe"]
    selected = proposal["selected_true_merit_candidate_pending_child_acceptance"]
    raw = v19_84_selected_raw_vector()
    ...
    prior = json.loads(Path(
        "artifacts/BHSM_aether_n3_thirtieth_bidirectional_fallback_child_v19_81.json"
    ).read_text(encoding="utf-8"))["thirtieth_bidirectional_fallback_child"]["child_state"]
    germ = _pack_child(
    ...
    return {
        ...
        "source_event": "v19.84_bidirectional_exact_merit_candidate",
...
def completion_payload() -> dict[str, Any]:
    result = thirty_first_bidirectional_probe_child()
    chart = result["chart"]
    ...
    return {
        "artifact": "BHSM_aether_n3_thirty_first_bidirectional_probe_child_v19_85",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "thirty_first_bidirectional_probe_child": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_thirty_first_bidirectional_probe_child_v19_85.json"
...
__all__ = [
    ...
    "thirty_first_bidirectional_probe_child", "completion_payload", "materialize",
]
