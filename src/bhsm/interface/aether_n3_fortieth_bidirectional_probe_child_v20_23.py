"""Reconstruct the complete child for the selected v20.22 merit state."""
...
VERSION = "v20.23"
CLASSIFICATION = "BHSM_N3_FORTIETH_BIDIRECTIONAL_PROBE_CHILD"
FULL_BHSM_COMPLETE = False


def fortieth_bidirectional_probe_child() -> dict[str, Any]:
    proposal_artifact = json.loads(Path(
        "artifacts/BHSM_aether_n3_fortieth_bidirectional_merit_manifold_probe_v20_22.json"
    ).read_text(encoding="utf-8"))
    proposal = proposal_artifact["fortieth_bidirectional_merit_manifold_probe"]
    selected = proposal["selected_true_merit_candidate_pending_child_acceptance"]
    raw = v20_22_selected_raw_vector()
    ...
    prior = json.loads(Path(
        "artifacts/BHSM_aether_n3_thirty_ninth_bidirectional_fallback_child_v20_19.json"
    ).read_text(encoding="utf-8"))["thirty_ninth_bidirectional_fallback_child"]["child_state"]
    germ = _pack_child(
    ...
    return {
        ...
        "source_event": "v20.22_bidirectional_exact_merit_candidate",
...
def completion_payload() -> dict[str, Any]:
    result = fortieth_bidirectional_probe_child()
    chart = result["chart"]
    ...
    return {
        "artifact": "BHSM_aether_n3_fortieth_bidirectional_probe_child_v20_23",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "fortieth_bidirectional_probe_child": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_fortieth_bidirectional_probe_child_v20_23.json"
...
__all__ = [
    ...
    "fortieth_bidirectional_probe_child", "completion_payload", "materialize",
]
