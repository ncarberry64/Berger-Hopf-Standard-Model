"""Reconstruct the complete child for the selected v18.62 merit state."""
...
VERSION = "v18.63"
CLASSIFICATION = "BHSM_N3_THIRD_BIDIRECTIONAL_PROBE_CHILD"
FULL_BHSM_COMPLETE = False


def third_bidirectional_probe_child() -> dict[str, Any]:
    proposal = json.loads(Path("artifacts/BHSM_aether_n3_third_bidirectional_merit_manifold_probe_v18_62.json").read_text(encoding="utf-8"))["third_bidirectional_merit_manifold_probe"]
    selected = proposal["selected_true_merit_candidate_pending_child_acceptance"]
    raw = v18_62_selected_raw_vector()
    ...
    prior = json.loads(Path("artifacts/BHSM_aether_n3_second_bidirectional_probe_child_v18_57.json").read_text(encoding="utf-8"))["second_bidirectional_probe_child"]["child_state"]
    ...
    return {
        ...
        "source_event": "v18.62_bidirectional_exact_merit_candidate",
        "source_solver_interpretation": "INVALIDATED_NOT_REASSERTED",
        "source_germ": "v18.57_child_of_accepted_v18.58_state",
...
def completion_payload() -> dict[str, Any]:
    result = third_bidirectional_probe_child()
    chart = result["chart"]
    ...
    return {
        "artifact": "BHSM_aether_n3_third_bidirectional_probe_child_v18_63",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "third_bidirectional_probe_child": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_third_bidirectional_probe_child_v18_63.json"
    path.write_text(deterministic_json(completion_payload()), encoding="utf-8")
    return path


__all__ = ["VERSION", "CLASSIFICATION", "FULL_BHSM_COMPLETE", "third_bidirectional_probe_child", "completion_payload", "materialize"]
