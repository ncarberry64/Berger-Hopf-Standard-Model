"""Remeasure direct residual response scales at accepted v20.06."""
...
from bhsm.interface.aether_n3_thirty_sixth_bidirectional_probe_promotion_v20_06 import (
    v20_06_selected_raw_vector,
)


VERSION = "v20.07"
CLASSIFICATION = "BHSM_N3_FORTIETH_DIRECT_RESIDUAL_SCALE_AUDIT"
FULL_BHSM_COMPLETE = False
SOURCE_NORM = 0.768902386537366
STEPS_V19_83 = (*STEPS_V18_70, 1.0e-8, 3.0e-9)


def fortieth_direct_residual_scale_audit() -> dict[str, Any]:
...
def completion_payload() -> dict[str, Any]:
    result = fortieth_direct_residual_scale_audit()
    ...
    return {
        "artifact": "BHSM_aether_n3_fortieth_direct_residual_scale_audit_v20_07",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "fortieth_direct_residual_scale_audit": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_fortieth_direct_residual_scale_audit_v20_07.json"
...
__all__ = [
    ...
    "CLASSIFICATION",
    "FULL_BHSM_COMPLETE",
    "fortieth_direct_residual_scale_audit",
    "completion_payload",
    "materialize",
]
