"""Continue exact-action directional-event merit descent from v18.25."""
...
VERSION = "v18.26"
CLASSIFICATION = "BHSM_N3_SECOND_DIRECTIONAL_EVENT_MERIT_DESCENT"
FULL_BHSM_COMPLETE = False


def second_directional_event_merit_descent() -> dict[str, Any]:
    """Measure and trial the local exact merit direction at accepted v18.25."""
    ...
    for epsilon in (1.0e-4, 3.0e-5, 1.0e-5):
        ...
        response_checks.append({
            ...
            "relative_residual": float(
                np.linalg.norm(predicted_jv - finite)
    ...
    return {
        ...
        "predicted_unit_direction_merit_slope": -float(
            np.linalg.norm(merit_gradient)
        ),
        "scaled_merit_direction_hex": [float(value).hex() for value in direction],
...
def completion_payload() -> dict[str, Any]:
    ...
    validation = {
        ...
        "directional_event_only": (
            result["event_response"]["type"] == "DIRECTIONAL_HESSIAN_VECTOR_ONLY"
        ...
        "response_direction_validated": (
            result["maximum_response_relative_residual"] < 2.0e-2
        ),
        "resolved_merit_slope_negative": all(
            slope < 0.0 for slope in resolved_slopes
        ),
    ...
    return {
        "artifact": "BHSM_aether_n3_second_directional_event_merit_descent_v18_26",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "second_directional_event_merit_descent": result,
        "status": "VALIDATED" if passed else "INVALIDATED",
        "real_physical_property_explained": (
            "THE_ACCEPTED_V18_25_STATE_HAS_A_LOCALLY_VALID_EXACT_ACTION_PLUS_"
            "DIRECTIONAL_EVENT_MERIT_RESPONSE"
        ),
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_second_directional_event_merit_descent_v18_26.json"
...
__all__ = [
    ...
    "CLASSIFICATION",
    "FULL_BHSM_COMPLETE",
    "second_directional_event_merit_descent",
    "completion_payload",
    "materialize",
]
