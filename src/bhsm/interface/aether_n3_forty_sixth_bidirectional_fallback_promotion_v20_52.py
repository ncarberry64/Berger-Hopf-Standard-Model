"""Promote the v20.51 fallback child only after the complete physical gate."""
...
from bhsm.interface.aether_n3_forty_sixth_bidirectional_fallback_child_v20_51 import (
    v20_51_selected_raw_vector,
)
from bhsm.interface.aether_n3_forty_fifth_bidirectional_probe_promotion_v20_46 import (
    v20_46_selected_raw_vector,
)


VERSION = "v20.52"
CLASSIFICATION = "BHSM_N3_FORTY_SIXTH_BIDIRECTIONAL_FALLBACK_PROMOTION"
FULL_BHSM_COMPLETE = False


def v20_52_selected_raw_vector() -> np.ndarray:
    return v20_51_selected_raw_vector().copy()


def forty_sixth_bidirectional_fallback_promotion() -> dict[str, Any]:
    reconstruction = json.loads(
        Path(
            "artifacts/"
            "BHSM_aether_n3_forty_sixth_bidirectional_fallback_child_v20_51.json"
        ).read_text(encoding="utf-8")
    )
    child = reconstruction["forty_sixth_bidirectional_fallback_child"]
    ...
    source_raw = v20_46_selected_raw_vector()
    raw = v20_52_selected_raw_vector()
...
def completion_payload() -> dict[str, Any]:
    result = forty_sixth_bidirectional_fallback_promotion()
    ...
    return {
        "artifact": (
            "BHSM_aether_n3_forty_sixth_bidirectional_fallback_promotion_v20_52"
        ),
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "forty_sixth_bidirectional_fallback_promotion": result,
...
__all__ = [
    ...
    "forty_sixth_bidirectional_fallback_promotion",
    "completion_payload",
    "materialize",
]
