"""Reconstruct the complete child for the independent v18.31 proposal."""
...
VERSION = "v18.32"
CLASSIFICATION = "BHSM_N3_CONGRUENT_PROPOSAL_CHILD_RECONSTRUCTION"
FULL_BHSM_COMPLETE = False


def congruent_proposal_child_reconstruction() -> dict[str, Any]:
    raw = v18_31_selected_raw_vector()
    ...
    prior_child = prior["second_complete_child_chart_reconstruction"]["child_state"]
    germ = _pack_child(
    ...
    return {
        "source_event": "v18.31_independent_exact_merit_proposal",
        "source_solver_model": "INVALIDATED_NOT_REASSERTED",
        "source_germ": "v18.28_validated_complete_child",
...
def completion_payload() -> dict[str, Any]:
    result = congruent_proposal_child_reconstruction()
    chart = result["chart"]
    ...
    return {
        "artifact": "BHSM_aether_n3_congruent_proposal_child_reconstruction_v18_32",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "congruent_proposal_child_reconstruction": result,
        "status": "VALIDATED" if passed else "INVALIDATED",
        "real_physical_property_explained": (
            "THE_INDEPENDENT_EXACT_MERIT_PROPOSAL_SELECTS_A_COMPLETE_MOVING_"
            "CHILD_WITHOUT_RELYING_ON_THE_INVALIDATED_NEWTON_CLAIM"
        ),
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_congruent_proposal_child_reconstruction_v18_32.json"
