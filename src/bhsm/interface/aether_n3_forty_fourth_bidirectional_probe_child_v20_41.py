"""Reconstruct the complete child for the selected v20.40 merit state."""
...
VERSION = "v20.41"
CLASSIFICATION = "BHSM_N3_FORTY_FOURTH_BIDIRECTIONAL_PROBE_CHILD"
FULL_BHSM_COMPLETE = False


def forty_fourth_bidirectional_probe_child() -> dict[str, Any]:
    ...
    proposal = proposal_artifact["forty_fourth_bidirectional_merit_manifold_probe"]
    selected = proposal["selected_true_merit_candidate_pending_child_acceptance"]
    raw = v20_40_selected_raw_vector()
    ...
    ).read_text(encoding="utf-8"))["forty_third_bidirectional_probe_child"]["child_state"]
    germ = _pack_child(
    ...
    return {
        ...
        "source_event": "v20.40_bidirectional_exact_merit_candidate",
...
def completion_payload() -> dict[str, Any]:
    result = forty_fourth_bidirectional_probe_child()
    chart = result["chart"]
    ...
    return {
        "artifact": "BHSM_aether_n3_forty_fourth_bidirectional_probe_child_v20_41",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "forty_fourth_bidirectional_probe_child": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_forty_fourth_bidirectional_probe_child_v20_41.json"
...
__all__ = [
    ...
    "forty_fourth_bidirectional_probe_child", "completion_payload", "materialize",
]
