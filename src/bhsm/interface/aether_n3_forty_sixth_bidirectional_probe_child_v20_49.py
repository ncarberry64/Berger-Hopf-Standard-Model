"""Reconstruct the complete child for the selected v20.48 merit state."""
...
VERSION = "v20.49"
CLASSIFICATION = "BHSM_N3_FORTY_SIXTH_BIDIRECTIONAL_PROBE_CHILD"
FULL_BHSM_COMPLETE = False


def forty_sixth_bidirectional_probe_child() -> dict[str, Any]:
    proposal_artifact = json.loads(Path(
        "artifacts/BHSM_aether_n3_forty_sixth_bidirectional_merit_manifold_probe_v20_48.json"
    ).read_text(encoding="utf-8"))
    proposal = proposal_artifact["forty_sixth_bidirectional_merit_manifold_probe"]
    selected = proposal["selected_true_merit_candidate_pending_child_acceptance"]
    raw = v20_48_selected_raw_vector()
    ...
    ).read_text(encoding="utf-8"))["forty_fifth_bidirectional_probe_child"]["child_state"]
    germ = _pack_child(
    ...
    return {
        ...
        "source_event": "v20.48_bidirectional_exact_merit_candidate",
...
def completion_payload() -> dict[str, Any]:
    result = forty_sixth_bidirectional_probe_child()
    chart = result["chart"]
    ...
    return {
        "artifact": "BHSM_aether_n3_forty_sixth_bidirectional_probe_child_v20_49",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "forty_sixth_bidirectional_probe_child": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_forty_sixth_bidirectional_probe_child_v20_49.json"
...
__all__ = [
    ...
    "forty_sixth_bidirectional_probe_child", "completion_payload", "materialize",
]
