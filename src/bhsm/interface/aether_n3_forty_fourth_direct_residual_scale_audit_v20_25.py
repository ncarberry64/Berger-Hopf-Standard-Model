"""Remeasure direct residual response scales at accepted v20.24."""
...
from bhsm.interface.aether_n3_fortieth_bidirectional_probe_promotion_v20_24 import (
    v20_24_selected_raw_vector,
)


VERSION = "v20.25"
CLASSIFICATION = "BHSM_N3_FORTY_FOURTH_DIRECT_RESIDUAL_SCALE_AUDIT"
FULL_BHSM_COMPLETE = False
SOURCE_NORM = 0.767729672729035
STEPS_V19_83 = (*STEPS_V18_70, 1.0e-8, 3.0e-9)


def forty_fourth_direct_residual_scale_audit() -> dict[str, Any]:
...
def completion_payload() -> dict[str, Any]:
    result = forty_fourth_direct_residual_scale_audit()
    ...
    return {
        "artifact": "BHSM_aether_n3_forty_fourth_direct_residual_scale_audit_v20_25",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "forty_fourth_direct_residual_scale_audit": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_forty_fourth_direct_residual_scale_audit_v20_25.json"
...
__all__ = [
    ...
    "CLASSIFICATION",
    "FULL_BHSM_COMPLETE",
    "forty_fourth_direct_residual_scale_audit",
    "completion_payload",
    "materialize",
]
