"""Remeasure direct residual response scales at accepted v19.90."""
...
from bhsm.interface.aether_n3_thirty_second_bidirectional_probe_promotion_v19_90 import (
    v19_90_selected_raw_vector,
)


VERSION = "v19.91"
CLASSIFICATION = "BHSM_N3_THIRTY_SIXTH_DIRECT_RESIDUAL_SCALE_AUDIT"
FULL_BHSM_COMPLETE = False
SOURCE_NORM = 0.777122666596459
STEPS_V19_83 = (*STEPS_V18_70, 1.0e-8, 3.0e-9)


def thirty_sixth_direct_residual_scale_audit() -> dict[str, Any]:
...
def completion_payload() -> dict[str, Any]:
    result = thirty_sixth_direct_residual_scale_audit()
    ...
    return {
        "artifact": "BHSM_aether_n3_thirty_sixth_direct_residual_scale_audit_v19_91",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "thirty_sixth_direct_residual_scale_audit": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_thirty_sixth_direct_residual_scale_audit_v19_91.json"
...
__all__ = [
    ...
    "CLASSIFICATION",
    "FULL_BHSM_COMPLETE",
    "thirty_sixth_direct_residual_scale_audit",
    "completion_payload",
    "materialize",
]
