"""Reconstruct the complete child for the selected v19.09 merit state."""
...
VERSION = "v19.10"
CLASSIFICATION = "BHSM_N3_FOURTEENTH_BIDIRECTIONAL_PROBE_CHILD"
FULL_BHSM_COMPLETE = False


def fourteenth_bidirectional_probe_child() -> dict[str, Any]:
    proposal_artifact = json.loads(Path(
        "artifacts/BHSM_aether_n3_fourteenth_bidirectional_merit_manifold_probe_v19_09.json"
    ).read_text(encoding="utf-8"))
    proposal = proposal_artifact["fourteenth_bidirectional_merit_manifold_probe"]
    selected = proposal["selected_true_merit_candidate_pending_child_acceptance"]
    raw = v19_09_selected_raw_vector()
    ...
    ).read_text(encoding="utf-8"))["thirteenth_bidirectional_probe_child"]["child_state"]
    germ = _pack_child(
    ...
    return {
        ...
        "source_event": "v19.09_bidirectional_exact_merit_candidate",
...
def completion_payload() -> dict[str, Any]:
    result = fourteenth_bidirectional_probe_child()
    chart = result["chart"]
    ...
    return {
        "artifact": "BHSM_aether_n3_fourteenth_bidirectional_probe_child_v19_10",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "fourteenth_bidirectional_probe_child": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_fourteenth_bidirectional_probe_child_v19_10.json"
...
__all__ = [
    ...
    "fourteenth_bidirectional_probe_child", "completion_payload", "materialize",
]
