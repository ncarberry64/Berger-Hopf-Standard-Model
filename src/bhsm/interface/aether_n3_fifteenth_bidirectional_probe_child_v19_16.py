"""Reconstruct the complete child for the selected v19.15 merit state."""
...
VERSION = "v19.16"
CLASSIFICATION = "BHSM_N3_FIFTEENTH_BIDIRECTIONAL_PROBE_CHILD"
FULL_BHSM_COMPLETE = False


def fifteenth_bidirectional_probe_child() -> dict[str, Any]:
    proposal_artifact = json.loads(Path(
        "artifacts/BHSM_aether_n3_fifteenth_bidirectional_merit_manifold_probe_v19_15.json"
    ).read_text(encoding="utf-8"))
    proposal = proposal_artifact["fifteenth_bidirectional_merit_manifold_probe"]
    selected = proposal["selected_true_merit_candidate_pending_child_acceptance"]
    raw = v19_15_selected_raw_vector()
    ...
    prior = json.loads(Path(
        "artifacts/BHSM_aether_n3_fourteenth_bidirectional_fallback_child_v19_12.json"
    ).read_text(encoding="utf-8"))["fourteenth_bidirectional_fallback_child"]["child_state"]
    germ = _pack_child(
    ...
    return {
        ...
        "source_event": "v19.15_bidirectional_exact_merit_candidate",
        "source_solver_interpretation": "INVALIDATED_NOT_REASSERTED",
        "source_germ": "v19.12_child_of_accepted_v19.13_state",
...
def completion_payload() -> dict[str, Any]:
    result = fifteenth_bidirectional_probe_child()
    chart = result["chart"]
    ...
    return {
        "artifact": "BHSM_aether_n3_fifteenth_bidirectional_probe_child_v19_16",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "fifteenth_bidirectional_probe_child": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_fifteenth_bidirectional_probe_child_v19_16.json"
...
__all__ = [
    ...
    "fifteenth_bidirectional_probe_child", "completion_payload", "materialize",
]
