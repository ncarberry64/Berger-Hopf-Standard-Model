"""Remeasure direct residual response scales at accepted v19.94."""
...
from bhsm.interface.aether_n3_thirty_third_bidirectional_probe_promotion_v19_94 import (
    v19_94_selected_raw_vector,
)


VERSION = "v19.95"
CLASSIFICATION = "BHSM_N3_THIRTY_SEVENTH_DIRECT_RESIDUAL_SCALE_AUDIT"
FULL_BHSM_COMPLETE = False
SOURCE_NORM = 0.774048801461998
STEPS_V19_83 = (*STEPS_V18_70, 1.0e-8, 3.0e-9)


def thirty_seventh_direct_residual_scale_audit() -> dict[str, Any]:
...
def completion_payload() -> dict[str, Any]:
    result = thirty_seventh_direct_residual_scale_audit()
    ...
    return {
        "artifact": "BHSM_aether_n3_thirty_seventh_direct_residual_scale_audit_v19_95",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "thirty_seventh_direct_residual_scale_audit": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_thirty_seventh_direct_residual_scale_audit_v19_95.json"
...
__all__ = [
    ...
    "CLASSIFICATION",
    "FULL_BHSM_COMPLETE",
    "thirty_seventh_direct_residual_scale_audit",
    "completion_payload",
    "materialize",
]
