"""Remeasure direct residual response scales at accepted v19.13."""
...
from bhsm.interface.aether_n3_fourteenth_bidirectional_fallback_promotion_v19_13 import (
    v19_13_selected_raw_vector,
)


VERSION = "v19.14"
CLASSIFICATION = "BHSM_N3_EIGHTEENTH_DIRECT_RESIDUAL_SCALE_AUDIT"
FULL_BHSM_COMPLETE = False
SOURCE_NORM = 0.795953277613514


def eighteenth_direct_residual_scale_audit() -> dict[str, Any]:
...
def completion_payload() -> dict[str, Any]:
    result = eighteenth_direct_residual_scale_audit()
    ...
    return {
        "artifact": "BHSM_aether_n3_eighteenth_direct_residual_scale_audit_v19_14",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "eighteenth_direct_residual_scale_audit": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_eighteenth_direct_residual_scale_audit_v19_14.json"
...
__all__ = [
    ...
    "CLASSIFICATION",
    "FULL_BHSM_COMPLETE",
    "eighteenth_direct_residual_scale_audit",
    "completion_payload",
    "materialize",
]
