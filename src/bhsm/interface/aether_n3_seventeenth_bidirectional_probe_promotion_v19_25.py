"""Promote the v19.23 merit state only after the complete physical gate."""
...
from bhsm.interface.aether_n3_seventeenth_bidirectional_merit_manifold_probe_v19_23 import v19_23_selected_raw_vector
...
VERSION = "v19.25"
CLASSIFICATION = "BHSM_N3_SEVENTEENTH_BIDIRECTIONAL_PROBE_PROMOTION"
FULL_BHSM_COMPLETE = False


def v19_25_selected_raw_vector() -> np.ndarray:
    return v19_23_selected_raw_vector().copy()


def seventeenth_bidirectional_probe_promotion() -> dict[str, Any]:
    reconstruction = json.loads(Path(
        "artifacts/BHSM_aether_n3_seventeenth_bidirectional_probe_child_v19_24.json"
    ).read_text(encoding="utf-8"))
    child = reconstruction["seventeenth_bidirectional_probe_child"]
    ...
    source_raw = v19_21_selected_raw_vector()
...
def completion_payload() -> dict[str, Any]:
    result = seventeenth_bidirectional_probe_promotion()
    ...
    return {
        "artifact": "BHSM_aether_n3_seventeenth_bidirectional_probe_promotion_v19_25",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "seventeenth_bidirectional_probe_promotion": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_seventeenth_bidirectional_probe_promotion_v19_25.json"
    path.write_text(deterministic_json(completion_payload()), encoding="utf-8")
    return path


__all__ = [
    "VERSION", "CLASSIFICATION", "FULL_BHSM_COMPLETE", "v19_25_selected_raw_vector",
    "seventeenth_bidirectional_probe_promotion", "completion_payload", "materialize",
]
