"""Promote the v20.00 merit state only after the complete physical gate."""
...
from bhsm.interface.aether_n3_thirty_fifth_bidirectional_merit_manifold_probe_v20_00 import v20_00_selected_raw_vector
...
VERSION = "v20.02"
CLASSIFICATION = "BHSM_N3_THIRTY_FIFTH_BIDIRECTIONAL_PROBE_PROMOTION"
FULL_BHSM_COMPLETE = False


def v20_02_selected_raw_vector() -> np.ndarray:
    return v20_00_selected_raw_vector().copy()


def thirty_fifth_bidirectional_probe_promotion() -> dict[str, Any]:
    reconstruction = json.loads(Path(
        "artifacts/BHSM_aether_n3_thirty_fifth_bidirectional_probe_child_v20_01.json"
    ).read_text(encoding="utf-8"))
    child = reconstruction["thirty_fifth_bidirectional_probe_child"]
    ...
    source_raw = v19_98_selected_raw_vector()
...
def completion_payload() -> dict[str, Any]:
    result = thirty_fifth_bidirectional_probe_promotion()
    ...
    return {
        "artifact": "BHSM_aether_n3_thirty_fifth_bidirectional_probe_promotion_v20_02",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "thirty_fifth_bidirectional_probe_promotion": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_thirty_fifth_bidirectional_probe_promotion_v20_02.json"
    path.write_text(deterministic_json(completion_payload()), encoding="utf-8")
    return path


__all__ = [
    "VERSION", "CLASSIFICATION", "FULL_BHSM_COMPLETE", "v20_02_selected_raw_vector",
    "thirty_fifth_bidirectional_probe_promotion", "completion_payload", "materialize",
]
