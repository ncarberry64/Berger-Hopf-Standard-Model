"""Reconstruct the complete child for the selected v18.85 merit state."""
...
VERSION = "v18.86"
CLASSIFICATION = "BHSM_N3_EIGHTH_BIDIRECTIONAL_PROBE_CHILD"
FULL_BHSM_COMPLETE = False


def eighth_bidirectional_probe_child() -> dict[str, Any]:
    proposal_artifact = json.loads(Path(
        "artifacts/BHSM_aether_n3_eighth_bidirectional_merit_manifold_probe_v18_85.json"
    ).read_text(encoding="utf-8"))
    proposal = proposal_artifact["eighth_bidirectional_merit_manifold_probe"]
    selected = proposal["selected_true_merit_candidate_pending_child_acceptance"]
    raw = v18_85_selected_raw_vector()
    ...
    prior = json.loads(Path(
        "artifacts/BHSM_aether_n3_seventh_bidirectional_fallback_child_v18_82.json"
    ).read_text(encoding="utf-8"))["seventh_bidirectional_fallback_child"]["child_state"]
    germ = _pack_child(
    ...
    return {
        ...
        "source_event": "v18.85_bidirectional_exact_merit_candidate",
        "source_solver_interpretation": "INVALIDATED_NOT_REASSERTED",
        "source_germ": "v18.82_child_of_accepted_v18.83_state",
...
def completion_payload() -> dict[str, Any]:
    result = eighth_bidirectional_probe_child()
    chart = result["chart"]
    ...
    return {
        "artifact": "BHSM_aether_n3_eighth_bidirectional_probe_child_v18_86",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "eighth_bidirectional_probe_child": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_eighth_bidirectional_probe_child_v18_86.json"
...
__all__ = [
    ...
    "eighth_bidirectional_probe_child", "completion_payload", "materialize",
]
