"""Machine checks for the v15.7 public current-status contract."""
...
from .aether_nonlinear_norman_cycle_bvp_v15_7 import EXACT_NEXT_OBJECT, PRIMARY_VERDICT
...
CURRENT_SECTIONS = {
    ...
    "docs/README.md": ("## Current v15.7", "## Historical v11.5"),
    "docs/current_bhsm_status.md": ("## v15.7", "## v14.2"),
    "docs/BHSM_1_0_DEFINITION_OF_DONE.md": ("## Current v15.7", "## Historical v11.1"),
    "theory/gate_ledger.md": ("## v15.7", "## v14.1"),
    "CLI_REFERENCE.md": ("## Current v15.7", "## BHSM v11.2"),
    "ROADMAP.md": ("## Current v15.7", "## Historical v11.6"),
    "FALSIFICATION.md": ("## Current v15.7", "## Historical v11.6"),
}
