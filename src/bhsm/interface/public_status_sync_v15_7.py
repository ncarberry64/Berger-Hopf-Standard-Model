"""Machine checks for the v15.8 public current-status contract.
...
from .aether_backward_closure_existing_answer_audit_v15_8 import EXACT_NEXT_OBJECT, PRIMARY_VERDICT
...
CURRENT_SECTIONS = {
    ...
    "ARTIFACT_INDEX.md": ("## Current BHSM v15.8", "## BHSM v11.5"),
    "docs/README.md": ("## Current v15.8", "## Historical v11.5"),
    "docs/current_bhsm_status.md": ("## v15.8", "## v14.2"),
    "docs/BHSM_1_0_DEFINITION_OF_DONE.md": ("## Current v15.8", "## Historical v11.1"),
    "theory/gate_ledger.md": ("## v15.8", "## v14.1"),
    "CLI_REFERENCE.md": ("## Current v15.8", "## BHSM v11.2"),
    "ROADMAP.md": ("## Current v15.8", "## Historical v11.6"),
    "FALSIFICATION.md": ("## Current v15.8", "## Historical v11.6"),
}
