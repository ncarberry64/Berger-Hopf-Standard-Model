"""Promote the v20.08 merit state only after the complete physical gate."""
...
from bhsm.interface.aether_n3_thirty_seventh_bidirectional_merit_manifold_probe_v20_08 import v20_08_selected_raw_vector
...
VERSION = "v20.10"
CLASSIFICATION = "BHSM_N3_THIRTY_SEVENTH_BIDIRECTIONAL_PROBE_PROMOTION"
FULL_BHSM_COMPLETE = False


def v20_10_selected_raw_vector() -> np.ndarray:
    return v20_08_selected_raw_vector().copy()


def thirty_seventh_bidirectional_probe_promotion() -> dict[str, Any]:
    reconstruction = json.loads(Path(
        "artifacts/BHSM_aether_n3_thirty_seventh_bidirectional_probe_child_v20_09.json"
    ).read_text(encoding="utf-8"))
    child = reconstruction["thirty_seventh_bidirectional_probe_child"]
    ...
    source_raw = v20_06_selected_raw_vector()
...
def completion_payload() -> dict[str, Any]:
    result = thirty_seventh_bidirectional_probe_promotion()
    ...
    return {
        "artifact": "BHSM_aether_n3_thirty_seventh_bidirectional_probe_promotion_v20_10",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "thirty_seventh_bidirectional_probe_promotion": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_thirty_seventh_bidirectional_probe_promotion_v20_10.json"
    path.write_text(deterministic_json(completion_payload()), encoding="utf-8")
    return path


__all__ = [
    "VERSION", "CLASSIFICATION", "FULL_BHSM_COMPLETE", "v20_10_selected_raw_vector",
    "thirty_seventh_bidirectional_probe_promotion", "completion_payload", "materialize",
]
