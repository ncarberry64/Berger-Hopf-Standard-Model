"""Remeasure direct residual response scales at accepted v18.73."""
...
VERSION = "v18.74"
CLASSIFICATION = "BHSM_N3_NINTH_DIRECT_RESIDUAL_SCALE_AUDIT"
FULL_BHSM_COMPLETE = False
SOURCE_NORM = 0.807144219141348


def ninth_direct_residual_scale_audit() -> dict[str, Any]:
...
def completion_payload() -> dict[str, Any]:
    result = ninth_direct_residual_scale_audit()
    ...
    return {
        "artifact": "BHSM_aether_n3_ninth_direct_residual_scale_audit_v18_74",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "ninth_direct_residual_scale_audit": result,
        "status": "VALIDATED" if passed else "INVALIDATED",
        "real_physical_property_explained": (
            "THE_DIRECT_DERIVATIVE_SCALE_IS_REMEASURED_AFTER_THE_"
            "ACCEPTED_V18_73_STATE_CHANGE"
        ),
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_ninth_direct_residual_scale_audit_v18_74.json"
