"""Reconstruct the complete child for the selected v19.70 merit state."""
...
VERSION = "v19.71"
CLASSIFICATION = "BHSM_N3_TWENTY_EIGHTH_BIDIRECTIONAL_PROBE_CHILD"
FULL_BHSM_COMPLETE = False


def twenty_eighth_bidirectional_probe_child() -> dict[str, Any]:
    ...
    proposal = proposal_artifact["twenty_eighth_bidirectional_merit_manifold_probe"]
    selected = proposal["selected_true_merit_candidate_pending_child_acceptance"]
    raw = v19_70_selected_raw_vector()
    ...
    prior = json.loads(Path(
        "artifacts/BHSM_aether_n3_twenty_seventh_bidirectional_fallback_child_v19_67.json"
    ).read_text(encoding="utf-8"))["twenty_seventh_bidirectional_fallback_child"]["child_state"]
    germ = _pack_child(
    ...
    return {
        ...
        "source_event": "v19.70_bidirectional_exact_merit_candidate",
        "source_solver_interpretation": "INVALIDATED_NOT_REASSERTED",
        "source_germ": "v19.67_child_of_accepted_v19.68_state",
...
def completion_payload() -> dict[str, Any]:
    result = twenty_eighth_bidirectional_probe_child()
    chart = result["chart"]
    ...
    return {
        "artifact": "BHSM_aether_n3_twenty_eighth_bidirectional_probe_child_v19_71",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "twenty_eighth_bidirectional_probe_child": result,
        "status": "VALIDATED" if passed else "INVALIDATED",
        "real_physical_property_explained": (
            "THE_LOWEST_V19_70_EXACT_MERIT_STATE_SELECTS_A_COMPLETE_"
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_twenty_eighth_bidirectional_probe_child_v19_71.json"
...
__all__ = [
    ...
    "twenty_eighth_bidirectional_probe_child", "completion_payload", "materialize",
]
