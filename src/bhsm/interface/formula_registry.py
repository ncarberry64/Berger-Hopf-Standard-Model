...
def default_formula_registry(repository: str | Path | None = None) -> FormulaRegistry:
    ...
    entries = (
        ...
        FormulaCallableEntry("x_ch_production_vertex", "X_ch production vertex", "Production vertex callable.", None, {}, {}, "OPEN_THEOREM_REQUIRED", "theorem blocker", (), "OPEN_EXACT_MISSING_THEOREM", "X_ch remains open without an explicit artifact-backed theorem.", False),
        FormulaCallableEntry("neutrino_physical_basis_scale", "Neutrino physical basis/scale", "Physical neutral-sector interpretation callable.", None, {}, {}, "OPEN_THEOREM_REQUIRED", "theorem blocker", (), "OPEN_EXACT_MISSING_THEOREM", "Physical neutrino basis and dimensional scale remain open.", False),
        FormulaCallableEntry("cp_o_int_standalone_attachment", "Standalone CP O_int attachment", "Standalone production CP attachment callable.", None, {}, {}, "OPEN_THEOREM_REQUIRED", "theorem blocker", ("artifacts/BHSM_cp_holonomy_o_int_attachment_theorem_v1_1.json",), "OPEN_EXACT_MISSING_THEOREM", "The phase artifact does not close standalone CP O_int.", False),
    )
