"""Reconstruct the complete child for the selected v18.89 merit state."""
...
VERSION = "v18.90"
CLASSIFICATION = "BHSM_N3_NINTH_BIDIRECTIONAL_PROBE_CHILD"
FULL_BHSM_COMPLETE = False


def ninth_bidirectional_probe_child() -> dict[str, Any]:
    proposal_artifact = json.loads(Path(
        "artifacts/BHSM_aether_n3_ninth_bidirectional_merit_manifold_probe_v18_89.json"
    ).read_text(encoding="utf-8"))
    proposal = proposal_artifact["ninth_bidirectional_merit_manifold_probe"]
    selected = proposal["selected_true_merit_candidate_pending_child_acceptance"]
    raw = v18_89_selected_raw_vector()
    ...
    ).read_text(encoding="utf-8"))["eighth_bidirectional_probe_child"]["child_state"]
    germ = _pack_child(
    ...
    return {
        ...
        "source_event": "v18.89_bidirectional_exact_merit_candidate",
        "source_solver_interpretation": "INVALIDATED_NOT_REASSERTED",
        "source_germ": "v18.86_child_of_accepted_v18.87_state",
...
def completion_payload() -> dict[str, Any]:
    result = ninth_bidirectional_probe_child()
    chart = result["chart"]
    ...
    return {
        "artifact": "BHSM_aether_n3_ninth_bidirectional_probe_child_v18_90",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "ninth_bidirectional_probe_child": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_ninth_bidirectional_probe_child_v18_90.json"
...
__all__ = [
    ...
    "ninth_bidirectional_probe_child", "completion_payload", "materialize",
]
