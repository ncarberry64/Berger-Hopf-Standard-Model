"""Reconstruct the complete child for the selected v19.01 merit state."""
...
VERSION = "v19.02"
CLASSIFICATION = "BHSM_N3_TWELFTH_BIDIRECTIONAL_PROBE_CHILD"
FULL_BHSM_COMPLETE = False


def twelfth_bidirectional_probe_child() -> dict[str, Any]:
    proposal_artifact = json.loads(Path(
        "artifacts/BHSM_aether_n3_twelfth_bidirectional_merit_manifold_probe_v19_01.json"
    ).read_text(encoding="utf-8"))
    proposal = proposal_artifact["twelfth_bidirectional_merit_manifold_probe"]
    selected = proposal["selected_true_merit_candidate_pending_child_acceptance"]
    raw = v19_01_selected_raw_vector()
    ...
    ).read_text(encoding="utf-8"))["eleventh_bidirectional_probe_child"]["child_state"]
    germ = _pack_child(
    ...
    return {
        ...
        "source_event": "v19.01_bidirectional_exact_merit_candidate",
        "source_solver_interpretation": "INVALIDATED_NOT_REASSERTED",
        "source_germ": "v18.98_child_of_accepted_v18.99_state",
...
def completion_payload() -> dict[str, Any]:
    result = twelfth_bidirectional_probe_child()
    chart = result["chart"]
    ...
    return {
        "artifact": "BHSM_aether_n3_twelfth_bidirectional_probe_child_v19_02",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "twelfth_bidirectional_probe_child": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_twelfth_bidirectional_probe_child_v19_02.json"
...
__all__ = [
    ...
    "twelfth_bidirectional_probe_child", "completion_payload", "materialize",
]
