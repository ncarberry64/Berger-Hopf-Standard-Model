"""Reconstruct the complete child for the selected v18.93 merit state."""
...
VERSION = "v18.94"
CLASSIFICATION = "BHSM_N3_TENTH_BIDIRECTIONAL_PROBE_CHILD"
FULL_BHSM_COMPLETE = False


def tenth_bidirectional_probe_child() -> dict[str, Any]:
    proposal_artifact = json.loads(Path(
        "artifacts/BHSM_aether_n3_tenth_bidirectional_merit_manifold_probe_v18_93.json"
    ).read_text(encoding="utf-8"))
    proposal = proposal_artifact["tenth_bidirectional_merit_manifold_probe"]
    selected = proposal["selected_true_merit_candidate_pending_child_acceptance"]
    raw = v18_93_selected_raw_vector()
    ...
    ).read_text(encoding="utf-8"))["ninth_bidirectional_probe_child"]["child_state"]
    germ = _pack_child(
    ...
    return {
        ...
        "source_event": "v18.93_bidirectional_exact_merit_candidate",
        "source_solver_interpretation": "INVALIDATED_NOT_REASSERTED",
        "source_germ": "v18.90_child_of_accepted_v18.91_state",
...
def completion_payload() -> dict[str, Any]:
    result = tenth_bidirectional_probe_child()
    chart = result["chart"]
    ...
    return {
        "artifact": "BHSM_aether_n3_tenth_bidirectional_probe_child_v18_94",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "tenth_bidirectional_probe_child": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_tenth_bidirectional_probe_child_v18_94.json"
...
__all__ = [
    ...
    "tenth_bidirectional_probe_child", "completion_payload", "materialize",
]
