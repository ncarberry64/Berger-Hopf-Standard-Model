"""Promote the v18.85 merit state only after the complete physical gate."""
...
from bhsm.interface.aether_n3_eighth_bidirectional_merit_manifold_probe_v18_85 import v18_85_selected_raw_vector
...
VERSION = "v18.87"
CLASSIFICATION = "BHSM_N3_EIGHTH_BIDIRECTIONAL_PROBE_PROMOTION"
FULL_BHSM_COMPLETE = False


def v18_87_selected_raw_vector() -> np.ndarray:
    return v18_85_selected_raw_vector().copy()


def eighth_bidirectional_probe_promotion() -> dict[str, Any]:
    reconstruction = json.loads(Path(
        "artifacts/BHSM_aether_n3_eighth_bidirectional_probe_child_v18_86.json"
    ).read_text(encoding="utf-8"))
    child = reconstruction["eighth_bidirectional_probe_child"]
    ...
    source_raw = v18_83_selected_raw_vector()
...
def completion_payload() -> dict[str, Any]:
    result = eighth_bidirectional_probe_promotion()
    ...
    return {
        "artifact": "BHSM_aether_n3_eighth_bidirectional_probe_promotion_v18_87",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "eighth_bidirectional_probe_promotion": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_eighth_bidirectional_probe_promotion_v18_87.json"
    path.write_text(deterministic_json(completion_payload()), encoding="utf-8")
    return path


__all__ = [
    "VERSION", "CLASSIFICATION", "FULL_BHSM_COMPLETE", "v18_87_selected_raw_vector",
    "eighth_bidirectional_probe_promotion", "completion_payload", "materialize",
]
