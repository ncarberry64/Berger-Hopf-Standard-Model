"""Remeasure direct residual response scales at accepted v20.46."""
...
VERSION = "v20.47"
CLASSIFICATION = "BHSM_N3_FORTY_NINTH_DIRECT_RESIDUAL_SCALE_AUDIT"
FULL_BHSM_COMPLETE = False
SOURCE_NORM = 0.767033270581951
STEPS_V19_83 = (*STEPS_V18_70, 1.0e-8, 3.0e-9)


def forty_ninth_direct_residual_scale_audit() -> dict[str, Any]:
...
def completion_payload() -> dict[str, Any]:
    result = forty_ninth_direct_residual_scale_audit()
    ...
    return {
        "artifact": "BHSM_aether_n3_forty_ninth_direct_residual_scale_audit_v20_47",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "forty_ninth_direct_residual_scale_audit": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_forty_ninth_direct_residual_scale_audit_v20_47.json"
...
__all__ = [
    ...
    "CLASSIFICATION",
    "FULL_BHSM_COMPLETE",
    "forty_ninth_direct_residual_scale_audit",
    "completion_payload",
    "materialize",
]
