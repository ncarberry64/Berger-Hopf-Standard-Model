...
def claim_boundary() -> dict[str, Any]:
    return {
        ...
        "exact_next_calculation": (
            "CLOSE_THE_SAME_CENTER_INTERVAL_CONTRACTION_AND_REPEAT_THE_"
            "EVALUATED_AFFINE72_PROPER_TIME_GAUGE_BRST_AND_PRODUCT_DIRAC_"
            "COTANGENT_CONTRACTIONS_ON_THE_NONLINEAR_STOP_FAMILY,_COMPOSE_THE_HS_"
