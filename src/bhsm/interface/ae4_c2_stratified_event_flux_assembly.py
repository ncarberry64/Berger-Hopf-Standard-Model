...
def claim_boundary() -> dict[str, Any]:
    return {
        ...
        "exact_next_calculation": (
            "EVALUATE_THE_ACTION_DERIVED_NONZERO_AE4_CURRENT_C2_SECTOR_"
            "CALDERON_BLOCKS_IN_THIS_SINGLE_ASSEMBLY_STARTING_WITH_THE_GAUGE_"
            "BRST_PAIR_AND_HS_FERMION_MIXED_BLOCK_THEN_INSERT_THEM_IN_THE_"
            "DERIVED_EVENT_FLUX_BALANCE_WITHOUT_FITTED_NORMALIZATION"
        ),
    }
