...
def claim_boundary() -> dict[str, Any]:
    return {
        ...
        "exact_next_calculation": (
            "LIFT_THE_EVALUATED_CANONICAL_STOP_GAUGE_BRST_CENTER_BLOCK_TO_"
            "THE_CORRELATION_PRESERVING_NONLINEAR_STOP_FAMILY_WITH_MOVING_"
            "ENDPOINT_JETS,_EVALUATE_THE_HS_FERMION_MIXED_BLOCK,_THEN_INSERT_"
            "ALL_PHYSICAL_SECTORS_WITHOUT_FITTED_NORMALIZATION"
        ),
    }
