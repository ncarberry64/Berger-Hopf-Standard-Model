"""Apply the remeasured v18.38 direct residual response at v18.37."""
...
VERSION = "v18.39"
CLASSIFICATION = "BHSM_N3_SECOND_DIRECT_RESIDUAL_JFNK"
...
def second_direct_residual_jfnk() -> dict[str, Any]:
    ...
    return {
        "source_state": "v18.37_direct_line_exact_merit_promoted_state",
        ...
        "linear_solve": {
            "method": "GMRES_ON_REMEASURED_DIRECT_RESIDUAL_JVP_TIMES_ACTION_RIGHT_MAP",
            "rtol": GMRES_RTOL,
            "restart": GMRES_RESTART,
...
def completion_payload() -> dict[str, Any]:
    result = second_direct_residual_jfnk()
    ...
    validation = {
        "source_is_v18_37": result["source_state"].startswith("v18.37"),
    ...
    return {
        "artifact": "BHSM_aether_n3_second_direct_residual_jfnk_v18_39",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "second_direct_residual_jfnk": result,
        "status": (
        ...
        "real_physical_property_explained": (
            "THE_REMEASURED_DIRECT_RESIDUAL_RESPONSE_PROPOSES_THE_NEXT_LINE_"
            "WITHOUT_MAKING_SOLVER_VALIDITY_A_PHYSICAL_GATE"
        ),
        "dependency_advanced": "NONLINEAR_N3_EVENT_SADDLE_CLOSURE",
        "active_calculation": (
            "RECONSTRUCT_AND_TEST_THE_SELECTED_COMPLETE_CHILD_IF_PRESENT"
            if selected is not None
            else "RESOLVE_THE_DIRECT_RESPONSE_OR_EXACT_MERIT_LINE"
        ),
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_second_direct_residual_jfnk_v18_39.json"
