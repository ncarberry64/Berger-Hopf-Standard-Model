    ...
    for index, (cid, meaning, status) in enumerate(GATE_CHAIN):
        if cid == "G7_08_FORCE":
            meaning += (
                ...
                "Gate 7 remains open for the validated state-transition and "
                "upstream-history reverse pullback of the finite-core seed, and the maximal "
