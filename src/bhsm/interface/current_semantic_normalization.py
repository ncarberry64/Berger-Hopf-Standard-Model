...
GATE_CHAIN = [
    ...
    ("G7_07_ANGULAR_TAIL", "derive the actual eventual two-sided bound abs(D_tau R4)<=v, which closes the conditional angular barrier theorem without monotonicity, or derive an action-owned relative trace; finite optical length is excluded", "OPEN_CURRENT_OWNER"),
