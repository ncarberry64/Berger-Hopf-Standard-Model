...
GATE_CHAIN = [
    ...
    ("G7_07_ANGULAR_TAIL", "derive an outward Osgood envelope abs(D_tau R4)<=omega(R4), with omega=o(R) and integral dR/(R omega)=infinity; the logarithmic-speed class closes the angular barrier without monotonicity or bounded speed", "OPEN_CURRENT_OWNER"),
