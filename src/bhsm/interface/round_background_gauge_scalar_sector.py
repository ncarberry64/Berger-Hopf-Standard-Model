...
def build_artifact_payloads(repo_root: Path | None = None) -> dict[str, dict[str, Any]]:
    ...
    payloads = {
        ...
        "dirac": {**c("BHSM_round_background_Dirac_forward_link_v6_1"), "status": "BHSM_ROUND_BACKGROUND_DIRAC_INPUT_PACKAGE_NORMALIZED_CONDITIONALLY", "available": ["round orthonormal 4+2+1 frame", "Levi-Civita/spin-connection geometry", "physical S3/S7 measures", "Sp1 associated representations", "complex-Hopf integral weights", "canonical M5 connection", "neutral sigma parent field", "t0 normalization surface", "effective dimension M5"], "missing": ["parent spinor representation", "chirality mechanism", "physical M4 boundary/domain reduction", "fermion action normalization", "Yukawa/geometric mass operator", "particle map", "strict adiabatic window"], "next_Dirac_sprint_ready": False},
