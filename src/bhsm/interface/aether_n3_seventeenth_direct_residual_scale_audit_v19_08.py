"""Remeasure direct residual response scales at accepted v19.07."""
...
VERSION = "v19.08"
CLASSIFICATION = "BHSM_N3_SEVENTEENTH_DIRECT_RESIDUAL_SCALE_AUDIT"
FULL_BHSM_COMPLETE = False
SOURCE_NORM = 0.797206261170734


def seventeenth_direct_residual_scale_audit() -> dict[str, Any]:
...
def completion_payload() -> dict[str, Any]:
    result = seventeenth_direct_residual_scale_audit()
    ...
    return {
        "artifact": "BHSM_aether_n3_seventeenth_direct_residual_scale_audit_v19_08",
        "version": VERSION,
        "classification": CLASSIFICATION,
        "FULL_BHSM_COMPLETE": FULL_BHSM_COMPLETE,
        "seventeenth_direct_residual_scale_audit": result,
...
def materialize(directory: str | Path) -> Path:
    ...
    path = target / "BHSM_aether_n3_seventeenth_direct_residual_scale_audit_v19_08.json"
...
__all__ = [
    ...
    "CLASSIFICATION",
    "FULL_BHSM_COMPLETE",
    "seventeenth_direct_residual_scale_audit",
    "completion_payload",
    "materialize",
]
