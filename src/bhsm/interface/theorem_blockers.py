...
def default_theorem_blockers() -> TheoremBlockerRegistry:
    rows = (
        ...
        TheoremBlocker("neutrino_basis_scale_dirac_majorana", "Neutrino propagation-conditioned curvature response", "CONDITIONAL_NUMERICAL_CLOSURE_CANDIDATE",
                       "conditional dimensionless propagation-mass candidate", ("neutral_operator_kernel_BH",),
                       ("artifacts/BHSM_neutrino_dirac_majorana_basis_scale_theorem_v1_1.json", "artifacts/BHSM_interaction_theorem_closure_audit_v1_1.json", "artifacts/BHSM_neutrino_basis_scale_theorem_closure_attempt_v0_4.json", "artifacts/BHSM_neutrino_basis_scale_minimal_action_closure_v0_8.json", "artifacts/BHSM_neutral_scale_closure_report_v1_0.json", "artifacts/BHSM_legacy_neutral_scale_report_v1_1.json"),
                       "numeric neutral propagation radius, physical curvature normalization, and an action-derived dimensionally consistent mass functional", "Symbolic radius and curvature-map candidates exist, but no valid eV/GeV prediction follows; the legacy r^2 k functional has dimension mass/length for K=-nabla^2 ln rho.", False),
