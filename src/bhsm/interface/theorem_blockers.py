...
def default_theorem_blockers() -> TheoremBlockerRegistry:
    rows = (
        ...
        TheoremBlocker("neutrino_basis_scale_dirac_majorana", "Neutrino propagation-conditioned curvature response", "CONDITIONAL_NUMERICAL_CLOSURE_CANDIDATE",
                       ...
                       ("artifacts/BHSM_neutrino_basis_scale_minimal_action_closure_v0_8.json", "artifacts/BHSM_neutral_radius_curvature_report_v1_2.json", "artifacts/BHSM_neutral_spectral_report_v1_3.json"),
                       "numeric neutral stiffness length, physical K_neutral,eff, and admissible positivity proof", "The scalar mass-gap action analogue is artifact-backed and the neutral spectral theorem shape is conditional; no valid eV/GeV prediction follows.", False),
