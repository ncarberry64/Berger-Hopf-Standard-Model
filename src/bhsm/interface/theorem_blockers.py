...
def default_theorem_blockers() -> TheoremBlockerRegistry:
    rows = (
        ...
        TheoremBlocker("neutrino_basis_scale_dirac_majorana", "Neutrino propagation-conditioned curvature response", "CONDITIONAL_NUMERICAL_CLOSURE_CANDIDATE",
                       ...
                       "artifact-backed neutral propagation/localization radius and conversion of the dimensionless neutral response to physical curvature in m^-2", "The legacy corpus supplies a curvature mass functional, but no valid eV/GeV prediction follows without r_prop and physical k_neutral,eff.", False),
