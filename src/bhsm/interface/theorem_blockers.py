...
def default_theorem_blockers() -> TheoremBlockerRegistry:
    rows = (
        ...
        TheoremBlocker("neutrino_basis_scale_dirac_majorana", "Neutrino propagation-conditioned curvature response", "CONDITIONAL_NUMERICAL_CLOSURE_CANDIDATE",
                       ...
                       "artifact-backed dimensionful neutral scale mapping BHSM boundary response to eV/GeV", "The dimensionless response is conditional; no static rest-mass matrix or dimensional neutrino prediction follows.", False),
