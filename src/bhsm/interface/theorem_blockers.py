...
def default_theorem_blockers() -> TheoremBlockerRegistry:
    rows = (
        ...
        TheoremBlocker("neutrino_basis_scale_dirac_majorana", "Neutrino propagation-conditioned curvature response", "CONDITIONAL_NUMERICAL_CLOSURE_CANDIDATE",
                       ...
                       "artifact-backed dimensionful neutral unit anchor, normalized boundary measure, and threshold-to-energy map", "The dimensionless response is conditional; the neutral-scale audit finds no valid eV/GeV theorem input and emits no dimensional prediction.", False),
