...
def default_theorem_blockers() -> TheoremBlockerRegistry:
    rows = (
        ...
        TheoremBlocker("neutrino_basis_scale_dirac_majorana", "Neutrino propagation-conditioned curvature response", "CONDITIONAL_NUMERICAL_CLOSURE_CANDIDATE",
                       ...
                       ("artifacts/BHSM_neutrino_basis_scale_minimal_action_closure_v0_8.json", "artifacts/BHSM_neutral_radius_curvature_report_v1_2.json", "artifacts/BHSM_neutral_spectral_report_v1_3.json", "artifacts/BHSM_neutral_positivity_report_v1_4.json"),
                       "numeric neutral stiffness length and physical K_neutral,eff", "Exact positivity holds conditionally on the measurement-supported response cone; raw PSD remains false and complete-action derivation of the cone remains a limitation. No valid eV/GeV prediction follows.", False),
