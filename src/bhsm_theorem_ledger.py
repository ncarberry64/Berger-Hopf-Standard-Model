...
def theorem_status_rows() -> tuple[TheoremLedgerRow, ...]:
    ...
    return (
        ...
        TheoremLedgerRow("scalar_decoupling", "scalar/topographic decoupling", FINITE_BASIS_SCAFFOLD, False, ("full scalar action proof",), "Current proxy inventory has no forbidden/open scalar modes.", "Do not claim scalar decoupling fully proven."),
