...
| `F14` | The v8.3 obstruction is overturned only by an action-owned quadratic amplitude density with normalized frozen profiles, metric variation, and selected domain; finite label constraints or effective Yukawa inputs do not qualify. | `BLOCKED_EXACT_OBJECT_PROVED` |
