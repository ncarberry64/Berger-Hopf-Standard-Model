...
PHASE_THREE_J_INPUTS = {
    ...
    "interaction_theorem_closure_audit": "artifacts/BHSM_interaction_theorem_closure_audit_v1_1.json",
    "phase_three_i_gate_status": "artifacts/BHSM_phase_three_i_gate_status_v1_1.json",
}
...
def load_phase_three_j_inputs() -> dict[str, dict[str, Any]]:
    return {name: load_required(relative) for name, relative in PHASE_THREE_J_INPUTS.items()}
...
def source_artifact_list() -> list[str]:
    return list(PHASE_THREE_J_INPUTS.values())
