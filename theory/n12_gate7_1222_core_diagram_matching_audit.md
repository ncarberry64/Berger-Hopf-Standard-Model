...
The 1,222-segment exact-fiber core now occupies the finite-core `C2`
coefficient slot.  Its inverse-free backward impedance recurrence supplies a
pole-free Weyl value and coefficient cotangent for every real `z<0`.  The
maximal Friedrichs theorem supplies the unique abstract core-exhaustion limit.
