...
| `mixed_curvature_remainder` | `sum_{i<j} [nabla_i,nabla_j] for mixed Hopf/base/boundary/coframe channels` | `mixed_hopf_base_boundary_coframe_connection` | `new R_bundle` | `CURVATURE_FORMULA_OPEN` | The mixed connection coefficients and Clifford contraction are not defined. |
