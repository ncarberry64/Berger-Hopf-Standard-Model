...
Follow-up: [Theorem discharge: finite-width overlap rank](theorem_discharge_finite_width_overlap_rank.md) keeps CKM and PMNS values open because finite-width rank lifting still requires internal eigenfunction independence and numerical moment contractions.
