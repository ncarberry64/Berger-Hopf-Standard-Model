...
Follow-up: [Theorem discharge: finite-width overlap rank](theorem_discharge_finite_width_overlap_rank.md) shows how finite-width moment terms can in principle move beyond this outer-product limit, but rank three remains open until internal eigenfunction independence is derived.
