...
Sector-coupling bound status: v1.3B adds finite spectral, Frobenius, row-sum, Weyl, and relative-bound estimates. v1.3C adds structured block and generalized relative-bound diagnostics. The baseline and robustness cases are finite-basis relative-bound candidates; uniform infinite-basis control remains open.
...
Prove the full-action zero-mode/complement decomposition dim ker D_twist = 3 and lift the structured sector-coupling relative bound to a uniform infinite-basis estimate.
