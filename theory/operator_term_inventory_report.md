...
| `lichnerowicz_bundle_curvature_remainder` | `True` | `not represented by a proven existing term` | `OPEN` | Single missing complete-operator identification theorem gap remains: MIXED_CONNECTION_COEFFICIENT_RULE_GAP. |
