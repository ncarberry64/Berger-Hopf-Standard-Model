...
Final status: `BHSM_THEOREM_CANDIDATE_WITH_OPEN_ASSUMPTIONS`
Full theorem package status: `BHSM_THEOREM_PACKAGE_INCOMPLETE`
Final paper allowed: `False`
Zenodo release allowed: `False`
...
Do not prepare final paper/Zenodo release; attack the full operator domain, topological index, mirror exclusion, and infinite-basis H_T complement proof obligations.
