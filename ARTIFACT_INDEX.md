...
| CERN ROOT integration status | Header-only mapper and PyROOT `RDataFrame` wrapper gate | `integrations/cern-root/integration_status.json` | `OPTIONAL_ROOT_ADAPTER_NOT_RUNTIME_VALIDATED_IN_REPOSITORY_CI` | See `integrations/cern-root/README.md` |
