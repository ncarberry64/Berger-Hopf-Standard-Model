...
def main():
    ...
    with np.load(axisfile, allow_pickle=False) as z:
        axis_array = z['current_center_green_image_unit_mid'][14].copy()
    ...
    result = dict(algorithm='LONGITUDINAL_DIRECTIONAL_ERROR_RESIDUAL_INTERSECTION_V1',family=record['family'],
