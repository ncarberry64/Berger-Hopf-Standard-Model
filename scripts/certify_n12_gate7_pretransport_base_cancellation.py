...
def evaluate(root,midpoint_path,endpoint_path,adjoint_path,refined_path,out,midpoint_adjoint_path,midpoint_refined_path,midpoint_corrected,endpoint_corrected,export_models=False,pullback_state_errors=False,midpoint_base_path=None,endpoint_base_path=None):
    ...
    result=dict(algorithm='FULL_INPUT_PRETRANSPORT_BASE_RESIDUAL_HS_TRANSPORT_V3',physical_input_columns=74,projected_output_rows=74,
        proof_assumptions=[
...
def main():
    ...
    evaluate(args.evidence_root.resolve(),args.midpoint.resolve(),args.endpoint.resolve(),
             ...
             args.midpoint_refined.resolve(),args.midpoint_corrected.resolve(),args.endpoint_corrected.resolve(),args.export_models,args.pullback_state_errors,args.midpoint_base_residual.resolve(),args.endpoint_base_residual.resolve())
