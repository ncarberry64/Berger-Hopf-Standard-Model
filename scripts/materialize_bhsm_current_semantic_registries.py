...
def verify_current_lineage() -> None:
    ...
    if not (
        ...
        and incoming_finite_comparison["claim_boundary"][
            "finite_amplitude_compliance_remainder"
        ] == "CERTIFIED_ON_FULL_BOX"
        and incoming_finite_comparison["claim_boundary"][
            "finite_core_entire_amplitude_box_joint_sign"
        ] == "CERTIFIED_STRICT_POSITIVE"
        and incoming_finite_comparison["claim_boundary"][
        ...
        and maximal_relative_heat["claim_boundary"][
            "maximal_fixed_channel_relative_heat_cotangent"
        ] == "DERIVED"
        and maximal_relative_heat["adjudication"][
            "separate_maximal_child_amplitude_jet_required"
        ] is False
        and maximal_relative_heat["adjudication"][
            "complete_graded_angular_sum"
        ] == "OPEN_CURRENT_OWNER"
        and maximal_relative_heat["claim_boundary"][
            "actual_projected_KKT_root"
        ] == "OPEN"
        and maximal_graded_incoming["claim_boundary"][
            "maximal_incoming_full_graded_relative_heat_cotangent"
        ] == "CERTIFIED_SUMMABLE"
        and maximal_graded_incoming["adjudication"][
            "unknown_far_C2_tail_used_in_angular_majorant"
        ] is False
        and maximal_graded_incoming["claim_boundary"][
            "complete_joint_all_direction_graded_cotangent"
        ] == "OPEN"
        and maximal_graded_incoming["claim_boundary"][
            "actual_projected_Cauchy_tail"
        ] == "OPEN_CURRENT_OWNER"
        and maximal_tail_support["claim_boundary"][
            "fixed_C2_upstream_interface_full_graded_maximal_tail"
        ] == "CERTIFIED_CAUCHY"
        and maximal_tail_support["claim_boundary"][
            "incoming_amplitude_full_graded_maximal_tail"
        ] == "CERTIFIED_CAUCHY"
        and maximal_tail_support["claim_boundary"][
            "remaining_outgoing_C2_launch_tail"
        ] == "OPEN_CURRENT_OWNER"
        ...
        and rank72_route_adjudication["claim_boundary"][
            "finite_core_shortcut"
        ] == "CLOSED_INSUFFICIENT"
        and rank72_route_adjudication["claim_boundary"][
            "finite_optical_NHIM_absolute_route"
        ] == "CLOSED_NO_GO"
        and rank72_route_adjudication["claim_boundary"][
        ...
        and full_lower_weight_krawczyk["claim_boundary"][
            "full_lower_weight_Krawczyk_graph"
        ] == "CERTIFIED"
        and full_lower_weight_krawczyk["claim_boundary"][
