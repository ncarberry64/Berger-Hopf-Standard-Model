"""Evaluate the complete left-family input operator with shared residuals.
...
def evaluate(root, family, adjoint_path, refined_path, out, reuse=None):
    ...
    result=dict(algorithm='LEFT_FULL_INPUT_SHARED_RESIDUAL_VECTOR_OUTER_BOUND_V1',family=family,side='left',
