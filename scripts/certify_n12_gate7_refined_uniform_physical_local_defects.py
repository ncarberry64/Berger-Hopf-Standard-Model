"""Assemble the same uniform local operator using paired refined derivatives."""
...
spec=importlib.util.spec_from_file_location('_bhsm_refined_uniform_local_engine',ROOT/'scripts/certify_n12_gate7_uniform_physical_local_defects.py')
...
engine.WORK=WORK=ROOT/'artifacts/flagship_integration/.refined_uniform_physical_local_defect_work'
engine.ALGORITHM=ALGORITHM='REFINED_UNIFORM_PHYSICAL_HS_FROZEN_LOCAL_NEWTON_DEFECT_ARB512_V1'
