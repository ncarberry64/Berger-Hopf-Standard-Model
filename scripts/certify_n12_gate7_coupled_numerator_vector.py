...
def evaluate(root, family, adjoint_path, refined_path, out, components):
    ...
    print(json.dumps(dict(stage='anchor_slope')),flush=True)
    ...
    for component in components:
        ...
        print(json.dumps(dict(component=component,stage='uniform_residual',base_adjoint_defect=float(base_defect))),flush=True)
