...
def build_payload() -> dict[str, Any]:
    ...
    return {
        ...
        "adjudication": {
            ...
            "E0_event_side_Calderon_and_birth_load": "OPEN_CURRENT_OPERATOR_OWNER",
