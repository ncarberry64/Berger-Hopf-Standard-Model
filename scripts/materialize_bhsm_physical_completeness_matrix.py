...
def build_payload() -> dict[str, Any]:
    ...
    records = [
        ...
        _record(
            ...
            ("quadratic_spectrum",),
            ("inverse-free generalized eigenproblem", "simple-pole residue algebra"),
            ("frozen history S2 pencil", "Ward/BRST cancellation", "action-owned momentum map", "physical scale instance"),
        ),
        _record(
            "UNIVERSAL_CUBIC_AND_QUARTIC_VERTEX_GENERATOR",
        ...
        _record(
            ...
            ("Laurent ledger", "counterterm/ghost/Jacobian categories", "Ward residual checks", "observable-fit rejection"),
        ...
        _record(
            ...
            ("vertex_amplitude", "lsz", "decay_collision", "loop_renormalization"),
            ("tree contact-plus-exchange algebra", "two-to-two phase space and angular quadrature"),
        ...
        _record(
            ...
            ("basis-independent F1/F2 projector", "a_l=F2(0) readout"),
