...
def build_payload() -> dict[str, Any]:
    ...
    blockers = [
        ...
        {"id": "G7_CORRELATED_QUARTER_STEP_CENTER_STOP_WITNESS", "classification": "CURRENT_BLOCKER", "current_effect": "outward-enclose the analytic Omega9-and-higher nested-commutator remainder plus signed source-quadrature Y in the retained correlated quotient; then promote the certified Omega7-augmented center, rebuild center-dependent Z2, close radii and continuous margins, and apply scalar interval Newton at the shifted s=0 first hit"},
    ...
    gaps = [
        ...
        {"id": "RESPONSE_TO_CORRELATED_Y_Z1_Z2", "class": "C", "priority": 1, "status": "FINITE_EXACT_OMEGA7_AUGMENTED_GLOBAL_CORRELATED_MAGNUS8_COMPOSITION_CERTIFIED;_BINARY_MIDPOINT_COINCIDENCE_NOT_EXACT_ZERO;_OUTWARD_OMEGA9_AND_HIGHER_REMAINDER_SIGNED_SOURCE_QUADRATURE_Y_AND_Z2_TRANSFER_OPEN", "evidence": PATHS["arb_magnus8_leading_term"]},
    ...
    return {
        ...
        "exact_next_dependency": "OUTWARD_ENCLOSE_THE_ANALYTIC_OMEGA9_AND_HIGHER_NESTED_COMMUTATOR_REMAINDER_PLUS_SIGNED_SOURCE_QUADRATURE_Y_IN_THE_RETAINED_CORRELATED_QUOTIENT,_THEN_PROMOTE_THE_CERTIFIED_OMEGA7_AUGMENTED_CENTER,_REBUILD_CENTER_DEPENDENT_Z2,_CLOSE_RADII_AND_CONTINUOUS_MARGINS,_AND_APPLY_SCALAR_INTERVAL_NEWTON_AT_THE_SHIFTED_s_ZERO_FIRST_HIT",
        "FULL_BHSM_COMPLETE": False,
    }
