...
def build_payload() -> dict[str, Any]:
    ...
    blockers = [
        ...
        {"id": "G7_CORRELATED_QUARTER_STEP_CENTER_STOP_WITNESS", "classification": "CURRENT_BLOCKER", "current_effect": "attach a causal time-weighted outward signed-source Y radius vanishing at reset and the PROP16 Z1 tail to the frozen Decimal Gauss8 center, transfer Z2 by rebuilding center-dependent cone objects, close radii, continuous margins, and scalar interval Newton at the shifted s=0 first hit"},
    ...
    gaps = [
        ...
        {"id": "RESPONSE_TO_CORRELATED_Y_Z1_Z2", "class": "C", "priority": 1, "status": "DECIMAL_GAUSS8_PROP16_CENTER_FROZEN_AND_ALL_STORED_PRETERMINAL_NODES_POSITIVE;_CAUSAL_TIME_WEIGHTED_OUTWARD_Y_AND_PROP16_Z1_TAIL_PLUS_CENTER_DEPENDENT_Z2_CONE_REBUILD_OPEN", "evidence": PATHS["frozen_decimal_gauss8_center"]},
    ...
    return {
        ...
        "exact_next_dependency": "ATTACH_A_CAUSAL_TIME_WEIGHTED_OUTWARD_SIGNED_SOURCE_Y_RADIUS_THAT_VANISHES_AT_RESET_AND_THE_PROP16_Z1_TAIL_TO_THE_FROZEN_DECIMAL_GAUSS8_CENTER,_REBUILD_ONLY_CENTER_DEPENDENT_CONE_OBJECTS_TO_TRANSFER_Z2,_CLOSE_THE_RADII_POLYNOMIAL_AND_CONTINUOUS_PRETERMINAL_MARGINS,_AND_APPLY_SCALAR_INTERVAL_NEWTON_AT_THE_SHIFTED_TRANSVERSE_s_ZERO_FIRST_HIT",
        "FULL_BHSM_COMPLETE": False,
    }
