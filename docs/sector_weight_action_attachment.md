# Sector Weight Action Attachment v4.0

Status: `OPEN_MISSING_GAUGE_SECTOR_WEIGHT_ACTION_SOURCE`
...
Run `python -m bhsm.interface sector-weight-action-attachment --format json`.
