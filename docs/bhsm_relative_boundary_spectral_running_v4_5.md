# Relative-Boundary Spectral Running v4.5
...
At Z_i(mu0,rho0)=1, lambda_i is conditionally w_i/(6pi^2). Physical running requires Z_i(mu,rho), lower spectral and collar corrections, and an action-selected rho_i(mu).
