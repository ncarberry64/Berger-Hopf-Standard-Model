...
The candidate radial/angular split gives U(1): 1, SU(2): 3-1=2, and SU(3): 8-1=7. These are active tangent-shell residues, not gauge-boson counts. Direct classical Yang-Mills density sees the radial norm and does not derive this split.
