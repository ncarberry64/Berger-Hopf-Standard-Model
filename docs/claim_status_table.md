...
| Collar measure / extrinsic geometry | `DERIVED_CONDITIONAL_WITH_OPEN_GEOMETRIC_INPUTS` | `theory/theorem_discharge_collar_measure_extrinsic_geometry.md` | The symbolic collar Jacobian is conditionally derived, but `K(Y)`, `S`, boundary embedding, and normal orientation remain open and unfitted |
