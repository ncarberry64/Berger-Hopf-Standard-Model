# BHSM v4.6 Status and Open Gates
...
The operator class, principal symbol, frame-normalized residue, and whitened quadratic form are conditional. Their action source, physical running, coupling identification, CKM consequences, and full completion remain open.
