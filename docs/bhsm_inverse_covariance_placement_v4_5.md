# Inverse-Covariance Placement v4.5
...
The candidate placement is K_i proportional to 1/lambda_i and alpha_i proportional to lambda_i. Both placement and physical coupling identification remain action-gated.
