...
The front-page animation uses a checked-in 128-vector display sample derived
from the checksum-pinned PR #98 CMS dimuon validation source. The complete
benchmark covered 200,000 unique four-vectors and a replicated 2,000,000-vector
timed workload. The display sample is not substituted for the benchmark.
