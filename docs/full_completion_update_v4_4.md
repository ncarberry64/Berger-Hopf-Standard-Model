# Full Completion Update V4 4 v4.4

Status: `FULL_BHSM_NOT_COMPLETE`

Candidate: `BHSM_FULL_COMPLETION=conjunction(all gates)`
...
Conditional Hodge closure does not close gauge normalization or full BHSM.
...
Run `python -m bhsm.interface full-completion-update-v4-4 --format json`.
