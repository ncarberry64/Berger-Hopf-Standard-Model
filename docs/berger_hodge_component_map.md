...
Status: `CONDITIONAL_BERGER_HODGE_COMPONENT_MAP`

Candidate: `*(sigma1 wedge sigma2)=(r_fiber/r_base^2)sigma3; *(sigma2 wedge sigma3)=(1/r_fiber)sigma1; *(sigma3 wedge sigma1)=(1/r_fiber)sigma2`
...
The map is a conditional geometric consequence of the artifact-backed Berger metric and a chosen orientation; it does not select the gauge basis.
...
Run `python -m bhsm.interface berger-hodge-component-map --format json`.
