...
The denominator remains open without averaging, unit volume, and action attachment.
...
Run `python -m bhsm.interface denominator-update-v4-4 --format json`.
