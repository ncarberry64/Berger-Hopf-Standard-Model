# Hodge Star Metric Factors v4.3

Status: `CONDITIONAL_HODGE_STAR_METRIC_FACTORS`

Candidate: `S_gauge contains Tr(F wedge *F); * depends on g_Berger and its volume form`
...
Run `python -m bhsm.interface hodge-star-metric-factors --format json`.
