...
Current campaign: [v10.1 Relational Envelopment Holism](bhsm_relational_envelopment_holism_v10_1.md), with [action constraints](bhsm_relational_envelopment_action_constraints_v10_1.md), [Topological Buoyancy](bhsm_topological_buoyancy_v10_1.md), [time/entropy/conservation](bhsm_time_entropy_conservation_v10_1.md), [boundary complementarity](bhsm_boundary_complementarity_v10_1.md), and [neutrino identity](bhsm_neutrino_relational_identity_v10_1.md). It audits the [v10.0 Machian geometric-envelopment foundation](bhsm_machian_geometric_envelopment_foundation_v10_0.md) without erasing the [v9.1 geometry-only no-go](bhsm_geometry_only_geon_fr_carrier_completion_v9_1.md).
