...
Current campaign: [v10.3 three-mode relational envelopment](bhsm_three_mode_relational_envelopment_v10_3.md), with the [physical deformation action-domain audit](bhsm_physical_deformation_action_domain_v10_3.md), [spacetime-removal/depth gate](bhsm_spacetime_removal_depth_v10_3.md), [seam coordinate projection](bhsm_seam_coordinate_projection_v10_3.md), [interference-selected output gate](bhsm_interference_selected_output_scale_v10_3.md), and [global unit-anchor policy](bhsm_global_geometry_unit_anchor_v10_3.md). It records the author ontology `q_C,q_W,q_D`, finds no current action-owned `q_D`, excludes seam displacement from the mode count, and preserves the earlier one-mode audit as invalidated historical provenance.
