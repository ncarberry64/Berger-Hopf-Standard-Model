...
Current campaign: [v10.3 physical deformation action-domain theorem](bhsm_physical_deformation_action_domain_v10_3.md), with [seam--fold--Hopf unification](bhsm_seam_fold_hopf_unification_v10_3.md), [common-mode intertwiners](bhsm_common_envelopment_mode_intertwiner_v10_3.md), [embedding/radion constraints](bhsm_embedding_radion_constraint_analysis_v10_3.md), [common stress pullback](bhsm_common_domain_stress_pullback_v10_3.md), [global zero-mode closure](bhsm_global_zero_mode_closure_v10_3.md), and the [minimal selection theorem](bhsm_minimal_deformation_selection_theorem_v10_3.md). It preserves the v10.2 no-go, imports the exact seam--fold projection, and leaves the Hopf coupling unresolved rather than declaring physical inequivalence.
