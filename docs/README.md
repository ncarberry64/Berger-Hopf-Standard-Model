...
Current campaign: [v10.0 Machian geometric-envelopment foundation](bhsm_machian_geometric_envelopment_foundation_v10_0.md), with the [dynamic completion program](bhsm_dynamic_particle_completion_program_v10_0.md), [four completion marks](bhsm_completion_marks_v10_0.md), and [Long Future alignment](bhsm_long_future_alignment_v10_0.md). It conditionally extends, rather than erases, the [v9.1 geometry-only geon/FR no-go](bhsm_geometry_only_geon_fr_carrier_completion_v9_1.md), which remains authoritative for the original metric-plus-real-scalar action.
