...
Current campaign: [v10.4 constrained spacetime-removal depth](bhsm_spacetime_removal_depth_v10_4.md), with the [three-mode action gate](bhsm_three_mode_dynamic_action_v10_4.md), [global equilibrium and scale gate](bhsm_global_equilibrium_and_scale_v10_4.md), [particle-cycle gate](bhsm_physical_particle_cycles_v10_4.md), [generation/mass/mixing gate](bhsm_generation_mass_mixing_v10_4.md), and [final completion report](bhsm_final_completion_report_v10_4.md). It proves that the proper-volume candidate is removed by the Hamiltonian constraint and leaves selection among inequivalent geometric depth extensions to the author.
