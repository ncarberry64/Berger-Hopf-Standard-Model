# Boundary Operator Lower-Order Terms v4.6
...
The Laplace-type principal symbol leaves Berger/Ricci curvature, adjoint connection curvature, shape/collar, extrinsic-curvature, sector/projector, and scalar/topographic response terms open.
