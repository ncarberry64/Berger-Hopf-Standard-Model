# Frame Average Update V4 4 v4.4

Status: `OPEN_MISSING_FRAME_AVERAGE_NORMALIZATION`

Candidate: `(1/3) sum_a X_a`
...
A component sum does not imply division by three.
...
Run `python -m bhsm.interface frame-average-update-v4-4 --format json`.
