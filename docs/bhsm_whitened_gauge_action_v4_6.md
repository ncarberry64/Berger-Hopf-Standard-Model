...
The candidate quadratic identity is S_i=[1/(2 lambda_i)]<A_i,L_i(rho)A_i>=[1/(2 lambda_i)]<B_i,B_i>, with B_i=L_i(rho)^(1/2)A_i and lambda_i=[w_i/(6pi^2)]Z_i.
