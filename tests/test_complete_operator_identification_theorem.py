...
SINGLE_THEOREM_GAP = "BUNDLE_CONNECTION_CURVATURE_CLOSURE_GAP"
...
def test_final_v26_decision_uses_allowed_result_and_blocks_final_paper():
    ...
    assert decision.recommended_next_branch == "bhsm-v2.7-bundle-curvature-remainder"
...
def test_downstream_theorems_do_not_upgrade_from_v26_blocker():
    ...
    assert ht.recommended_next_branch == "bhsm-v2.7-bundle-curvature-remainder"
