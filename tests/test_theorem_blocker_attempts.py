...
def test_theorem_dispositions_follow_the_author_ontology():
...
def test_legacy_author_template_does_not_override_current_disposition():
    template=json.loads((ROOT/"data/theorem_inputs/theorem_input_template.json").read_text())
    assert attempt_theorem_closure("X_ch",ROOT,template).closure_status=="CONDITIONAL_ACTION_THEOREM"
