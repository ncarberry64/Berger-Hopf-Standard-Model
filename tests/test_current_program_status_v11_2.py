...
from bhsm.interface.completion.completion_gate_v11_5 import canonical_completion_gate_payload
from bhsm.interface.completion.completion_gate_v11_5 import EXACT_NEXT_OBJECT, PRIMARY_VERDICT
...
def test_python_current_status_is_v11_5_and_fail_closed() -> None:
...
def test_repository_current_surfaces_are_synchronized() -> None:
    for name in ("README.md", "STATUS.md", "CLAIMS.md", "ROADMAP.md", "FALSIFICATION.md"):
        ...
        assert "v11.5" in text.lower(), name
