from bhsm.interface.aether_n3_resolved_trial_complete_child_promotion_v18_09 import completion_payload


def test_resolved_trial_complete_child_promotion_validates():
    payload = completion_payload()
    assert payload["validation_passed"]
    result = payload["resolved_trial_complete_child_promotion"]
