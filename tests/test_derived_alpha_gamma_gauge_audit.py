...
def test_alpha_gamma_gauge_not_promoted_by_default():
    mod = load_mod()
    data = load_results()
    assert mod.alpha_gamma_gauge_fixed_derived() is False
    assert data["alpha_gamma_gauge_fixed_derived"] is False
