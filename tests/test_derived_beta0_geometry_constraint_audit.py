...
def test_beta0_geometry_fixed_not_promoted_by_default():
    mod = load_mod()
    data = load_results()
    assert mod.beta0_geometry_fixed_derived() is False
    assert data["beta0_geometry_fixed_derived"] is False
