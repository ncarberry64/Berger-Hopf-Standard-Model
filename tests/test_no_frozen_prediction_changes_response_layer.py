...
def test_frozen_prediction_files_are_unchanged_by_response_layer_sprint() -> None:
...
def test_response_json_declares_no_official_or_frozen_mutation() -> None:
    payload = json.loads((ROOT / "theory" / "response_layer_residual_decomposition_results.json").read_text())
