...
RESULT = ROOT / "artifacts/flagship_integration/BHSM_N12_GATE7_PROJECTED_EXACT_AFFINE_DENSE_CENTER_FLOW_DEFECT.json"
...
def test_projected_exact_affine_dense_flow_defect_is_routed() -> None:
    ...
    assert record["adjudication"]["projected_native_only_dense_audit"] == "SUPERSEDED"
...
def test_projected_exact_affine_dense_flow_provenance_matches_disk() -> None:
    record = json.loads(RESULT.read_text(encoding="utf-8"))
