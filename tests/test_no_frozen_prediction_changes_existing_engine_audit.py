...
def test_frozen_prediction_files_are_unchanged_by_existing_engine_audit() -> None:
...
def test_existing_engine_json_declares_no_official_or_frozen_mutation() -> None:
    payload = json.loads((ROOT / "theory" / "existing_engine_branch_threshold_results.json").read_text())
