...
from certify_n12_c2_translated_descriptor_ball import build_payload  # noqa: E402


ARTIFACT = ROOT / (
    "artifacts/flagship_integration/BHSM_N12_C2_TRANSLATED_DESCRIPTOR_BALL.json"
)


def test_translated_descriptor_payload_replays() -> None:
...
def test_translated_ball_preserves_all_canonical_margins() -> None:
    ...
    assert payload["adjudication"]["outcome"] == "REGULAR_FORWARD_CONTINUATION_AVAILABLE"
