...
def test_frozen_prediction_files_are_unchanged_by_residual_autopsy() -> None:
...
def test_autopsy_json_declares_no_official_or_frozen_mutation() -> None:
    payload = json.loads((ROOT / "theory" / "bare_yukawa_residual_autopsy_results.json").read_text())
