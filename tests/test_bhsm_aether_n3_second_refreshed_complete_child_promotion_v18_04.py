...
def test_second_refreshed_complete_child_promotion_validates():
    payload = completion_payload()
    assert payload["validation_passed"]
    result = payload["second_refreshed_complete_child_promotion"]
    ...
    assert v18_04_selected_raw_vector().shape == (376,)
