...
from bhsm.interface.aether_n3_second_direct_residual_jfnk_v18_39 import completion_payload


def test_v18_39_second_direct_residual_jfnk() -> None:
    payload = completion_payload()
    result = payload["second_direct_residual_jfnk"]
    assert result["source_state"].startswith("v18.37")
