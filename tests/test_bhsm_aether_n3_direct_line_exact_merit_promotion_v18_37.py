...
from bhsm.interface.aether_n3_direct_line_exact_merit_promotion_v18_37 import completion_payload
from bhsm.interface.aether_n3_fresh_sbp_asymmetric_period_v0_priority_v17_42 import deterministic_json


def test_v18_37_direct_line_exact_merit_promotion() -> None:
    payload = completion_payload()
    result = payload["direct_line_exact_merit_promotion"]
    ...
    assert Path(
        "artifacts/BHSM_aether_n3_direct_line_exact_merit_promotion_v18_37.json"
