...
from ht_domain_bridge import HT_THEOREM_REFERENCE_OPERATOR_CLOSED, build_ht_domain_bridge_report
...
def test_ht_bridge_records_reference_operator_closed_not_full_proof():
    ...
    assert report.domain_bridge_status == HT_THEOREM_REFERENCE_OPERATOR_CLOSED
