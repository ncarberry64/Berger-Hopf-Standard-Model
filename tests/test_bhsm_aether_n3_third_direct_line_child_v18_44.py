...
from bhsm.interface.aether_n3_third_direct_line_child_v18_44 import completion_payload


def test_v18_44_third_direct_line_child() -> None:
    payload = completion_payload()
    result = payload["third_direct_line_child"]
