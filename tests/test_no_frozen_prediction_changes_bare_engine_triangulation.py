...
def test_frozen_prediction_files_are_unchanged_by_triangulation() -> None:
...
def test_triangulation_json_declares_no_official_or_frozen_mutation() -> None:
    payload = json.loads((ROOT / "theory" / "bare_engine_triangulation_results.json").read_text())
