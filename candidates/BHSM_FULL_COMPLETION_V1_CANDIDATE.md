...
Status: `FULL_COMPLETION_CANDIDATE_NOT_OFFICIAL`

BHSM is not confirmed. This package is a completion candidate and falsification target.

## Candidate Scope

This candidate attempts to unify bare Berger-Hopf geometry, the released `c/t` virtual mass dressing, the candidate CKM 2-3 mixing dressing, gauge comparison, quark RG audit, scalar/gap status, and boundary operator derivation status without changing official frozen outputs.
