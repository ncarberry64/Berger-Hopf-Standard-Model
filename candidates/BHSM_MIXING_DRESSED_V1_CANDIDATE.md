...
- `Z_virt^{u,2} = 0.5`
- `CANDIDATE_MIXING_EXPONENT = 0.0625`
- `Z_MIX_23 = 0.9576032806985737`
...
| --- | ---: | ---: | --- |
| `Vcb` | `0.0673398` | `0.0220881` | `True` |
| `Vts` | `0.0382342` | `0.00541892` | `True` |
| `J_CKM` | `0.0337234` | `0.0100238` | `True` |
...
This candidate is not promoted. Promotion requires derivation of the 1/16 exponent from BHSM geometry, boundary operators, mode overlap order, or internal action before any future external comparison.
