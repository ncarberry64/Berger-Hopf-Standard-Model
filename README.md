...
| Full-completion audit | `FULL_BHSM_NOT_COMPLETE` | v4.1 conditionally localizes the collar measure and records three coframe directions; unit-S3 averaging, gauge attachment, CKM, scale, and transport gates remain open. |
