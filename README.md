...
| Full-completion audit | `FULL_BHSM_NOT_COMPLETE` | v4.3 finds the gauge coframe basis open and Hodge metric dependence conditional; averaging, attachment, couplings, CKM, scale, and transport remain open. |
