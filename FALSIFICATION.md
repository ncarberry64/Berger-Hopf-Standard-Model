...
measurement remain falsifiable only after their exact action-derived objects
are constructed. No frozen prediction changes in this campaign.

For v10.2, the present action is obstructed as a realization of Topological
Buoyancy: it has no varied physical normal embedding, no positive static
Hopf-radion equilibrium, no compactness-coupled global restoring constraint,
and no complete localized stress pullback. A future extension must derive all
