...
## Current v15.9 critical path

Start from the derived regular radial eta concentration branch. Select the
retained sigma coefficient branch from the action, solve the coupled
Einstein-eta-sigma constraints, and continue into a degree-one Hopf
parent-child enclosure. Then attach the existing self-adjoint machinery and
test nested-scale decoupling and relative-periodic/Floquet persistence.
